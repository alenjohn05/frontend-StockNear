...
<svelte:head>
  ...
  <dialog id="feedbackInfo" class="modal modal-bottom sm:modal-middle overflow-hidden">
      ...
      <button on:click={() => sendFeedback()} class="mb-4 btn bg-[#161b22] hover:bg-purple-500 {rating?.length !== 0 && inputValue?.length !== 0 ? 'opacity-100 cursor-pointer' : 'opacity-60 cursor-default'} btn-md w-full rounded-full m-auto text-white font-bold text-md">
          Send Feedback
      </button>
    ...
    <div class="drawer-side overflow-hidden">
        ...
        <div class="bg-[#0d1117] min-h-screen w-screen pb-20 overflow-hidden">
          ...
          <label for="feedbackInfo" on:click={handleReturn} class="absolute left-6 top-4">
            ...
            <button on:click={() => sendFeedback()} class="pl-7 pr-7 mb-4 flex justify-center items-center btn bg-[#161b22] hover:bg-purple-500 {rating?.length !== 0 && inputValue?.length !== 0 ? 'opacity-100 cursor-pointer' : 'opacity-60 cursor-default'} btn-md rounded-full w-5/6 m-auto text-white font-bold text-md">
                Send Feedback
            </button>
