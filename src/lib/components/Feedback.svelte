...
<svelte:head>
  ...
  <dialog id="feedbackInfo" class="modal modal-bottom sm:modal-middle overflow-hidden">
      ...
      <div class="p-2 mt-5 w-full ">
          <textarea
            class="textarea textarea-bordered  placeholder-gray-300 w-full bg-[#131722] text-white border border-gray-600"
        ...
        <div class="bg-[#131722] min-h-screen w-screen pb-20 overflow-hidden">
          ...
          <label for="feedbackInfo" on:click={handleReturn} class="absolute left-6 top-4">
            ...
            <div class="pl-7 pr-7 w-full ">
                <textarea
                  class="textarea textarea-bordered h-24 placeholder-gray-300 w-full bg-[#131722] text-white border border-gray-600"
                  placeholder="Your feedback..."
                  value={inputValue}
                  on:input={handleInput}
                  />
