...
<section class="bg-[#0d1117] overflow-hidden text-white h-full w-full sm:mb-10">
      ...
      <div class="relative flex justify-center items-center overflow-hidden w-full">
          <main class="w-full">
              ...
              <div class="flex flex-row items-end justify-between">
                ...
                <a href={$assetType === 'stock' ? `/stocks/${$stockTicker}/options` : `/etf/${$etfTicker}/options`} class="text-sm sm:text-[1rem] sm:hover:text-white text-[#FFBE00] font-normal">Full report</a>
              </div>
