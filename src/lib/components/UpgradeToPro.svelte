...
<a href="/pricing" class="mt-10 flex justify-center items-center w-56 m-auto btn text-white bg-[#161b22] hover:bg-purple-500 transition duration-150 ease-in-out group">
    Become a Pro
