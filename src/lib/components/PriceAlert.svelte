...
{#if $screenWidth >= 640}
    ...
    <label for="priceAlertModal"  class="cursor-pointer modal-backdrop bg-[#fff] bg-opacity-[0.02]"></label>
        ...
        <div class="modal-box rounded-none w-full bg-[#111111] h-[450px]" >
    
        <!--Start Trade Modal-->
        <label for="priceAlertModal" class="cursor-pointer absolute right-5 top-5 bg-[#111111] text-[1.8rem] text-white">
    ...
    <div class="drawer drawer-end overflow-hidden w-screen z-40">
        ...
        <div class="drawer-side overflow-y-scroll overflow-hidden">
          ...
          <div class="bg-[#111111] min-h-screen px-5 w-screen pb-20 overflow-y-scroll overflow-hidden">
        ...
        <div class="flex flex-wrap pl-5 rounded-xl bg-[#111111] max-w-sm mx-auto mt-5">
