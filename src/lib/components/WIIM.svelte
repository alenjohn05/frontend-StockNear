                        ...
                        <div class="">
                            ...
                            <div class="flex justify-center ">
                                ...
                                <div class="flex flex-row items-center w-full mb-6">
                                    ...
                                    <div class="w-full rounded-lg {latestInfoDate(item?.date) ? 'bg-[#F9AB00] bg-opacity-[0.1]' : 'bg-[#0d1117]'} shadow-lg h-full pl-3 pt-2 pb-4">
                                        <div class="flex flex-col items-start"> 
                                            ...
                                            {#if data?.user?.tier !== 'Pro' && latestInfoDate(item?.date)}
                                                <a href="/pricing" class="w-full max-w-xl mt-5 text-[#FFBE00] hover:text-white font-medium text-sm flex justify-center items-center">
