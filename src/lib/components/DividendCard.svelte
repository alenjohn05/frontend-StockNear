                ...
                <table class="table lg:table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                  <thead>
                    <tr class="border-b border-blue-400">
                      <th class="text-white font-semibold text-sm text-start bg-[#131722] lg:bg-[#131722] border-b border-blue-400">Ex-Dividend</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#131722] lg:bg-[#131722] border-b border-blue-400">Payment Date</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#131722] lg:bg-[#131722] border-b border-blue-400">Amount</th>
                    </tr>
                  </thead>
