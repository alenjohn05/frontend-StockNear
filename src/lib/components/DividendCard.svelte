                ...
                <table class="table lg:table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                  <thead>
                    <tr class="border-b border-blue-400">
                      <th class="text-white font-semibold text-sm text-start bg-[#111111] lg:bg-[#111111] border-b border-blue-400">Ex-Dividend</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#111111] lg:bg-[#111111] border-b border-blue-400">Payment Date</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#111111] lg:bg-[#111111] border-b border-blue-400">Amount</th>
                    </tr>
                  </thead>

                  <tbody>
                    {#each dividendHistoryList?.slice(0,5) as item}
                    <tr class="text-white bg-[#111111]  border border-slate-800lg:bg-[#111111] border-b border-[#000] lg:border-[#202020]">
