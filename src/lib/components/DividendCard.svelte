        ...
        if(dividendHistoryList?.length !== 0)
        {
          ...
          <div class="lg:rounded-2xl shadow-lg bg-[#0d1117] lg:bg-[#0d1117] lg:border lg:border-slate-800 h-auto {$screenWidth <= 800 ? 'w-screen pt-16' : ''} lg:w-96">
            ...
            <div class="w-auto lg:w-full p-1 flex-1 flex flex-wrap pb-5">
                ...
                <table class="table lg:table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                  <thead>
                    <tr class="border-b border-blue-400">
                      <th class="text-white font-semibold text-sm text-start bg-[#0d1117] lg:bg-[#0d1117] border-b border-blue-400">Ex-Dividend</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#0d1117] lg:bg-[#0d1117] border-b border-blue-400">Payment Date</th>
                      <th class="text-white font-semibold text-sm text-end bg-[#0d1117] lg:bg-[#0d1117] border-b border-blue-400">Amount</th>
                    </tr>
                  </thead>

                  <tbody>
                    {#each dividendHistoryList?.slice(0,5) as item}
                    <tr class="text-white bg-[#0d1117]  border border-slate-800lg:bg-[#0d1117] border-b border-[#000] lg:border-[#202020]">
              ...
              <label for="dividendModal" on:click={() => goto(`/etf/${$etfTicker}/dividends`)} class="rounded-lg cursor-pointer w-11/12 md:w-3/4 lg:w-11/12 py-2 h-full mt-8 lg:mt-6 text-[1rem] text-center font-semibold text-white m-auto hover:bg-[#161b22] bg-[#161b22] transition duration-100 ease-in">
