...
<input type="checkbox" id="userLogin" class="modal-toggle" />
    ...
    <dialog id="userLogin" class="modal modal-bottom sm:modal-middle border border-slate-800">
        ...
        <div class="modal-box w-full bg-[#0d1117] border border-[#2a2e39] border border-slate-800 {$screenWidth < 640 ? 'min-h-screen' : ''}">
                ...
                <div class="relative">
                    ...
                    <form action="?/login" method="POST" use:enhance={submitLogin} class="flex flex-col items-center space-y-2 w-full md:w-5/6 md:ml-auto md:mr-auto">
                        ...
                        <div class="w-full max-w-lg pt-5 m-auto pb-5">
                            <button type="submit" class="btn bg-[#27272A] border border-gray-600 sm:hover:bg-[#2A2E39] text-white btn-md w-full rounded-lg m-auto text-white font-semibold text-md">
                                Login
                            </button>
                        </div>
                        ...
                        <div class="flex flex-row items-center gap-x-5 pb-6">
							<form method="post" action="?/oauth2">
								...
								<button
									...
									class="cursor-pointer flex-shrink-0 rounded-full w-12 h-12 relative bg-[#27272A] flex items-center justify-center border border-gray-600 sm:hover:bg-[#2A2E39] text-white">
                        ...
                        <p class="pb-1 text-sm w-full max-w-lg text-gray-300 flex justify-center items-center">You don't have an account?
                            <label on:click={() => displaySection='register'} class="text-[#FFBE00] hover:underline  ml-1 cursor-pointer">Sign up</label>
                        </p>
                    </form>
                ...
                <div class="grid grid-cols-1 gap-4text-white animate-fade-in-once ">
                    ...
                    <form method="POST" action="?/register" use:enhance={submitRegistration} class="flex flex-col items-center space-y-2 w-full md:w-5/6 pt-4 md:ml-auto md:mr-auto">
                        ...
                        <div class="w-full max-w-lg pt-5 m-auto pb-3">
                            <button type="submit" class="btn bg-[#27272A] border border-gray-600 sm:hover:bg-[#2A2E39] text-white btn-md w-full rounded-lg m-auto font-semibold text-md">
                                Register
                            </button>
                        </div>
                        ...
                        <p class="pt-3 pb-1 text-sm w-full max-w-lg text-gray-300 flex justify-center items-center">You already have an account?
                            <label on:click={() => displaySection = 'login'} class="text-[#FFBE00] hover:underline  ml-1 cursor-pointer">Sign in</label>
                        </p>
                    </form>
                </div>
                </div>
...
<div class="drawer drawer-end overflow-hidden" style="z-index: 9999;">
    ...
    <div class="drawer-side">
        ...
        <div class="modal-box rounded-xl bg-[#0d1117] min-h-screen w-screen pb-20 overflow-y-auto">
