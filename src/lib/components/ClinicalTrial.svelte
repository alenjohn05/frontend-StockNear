...
<section class="overflow-hidden text-white h-full pb-8">
    <main class="overflow-hidden ">
        ...
        <div class="pb-2 rounded-lg bg-[#111111]">
          ...
          <table class="table table-sm table-compact table-pin-rows table-pin-cols w-full">
            <thead>
              <tr class="border-b border-blue-400">
                <th class="text-white shadow-md font-semibold text-sm text-start bg-[#111111]">Drug</th>
                <th class="text-white shadow-md font-semibold text-sm text-start bg-[#111111]">Stage</th>
                <th class="text-white shadow-md font-semibold text-sm text-center bg-[#111111]">Phase Status</th>
                <th class="text-white shadow-md font-semibold text-sm text-end bg-[#111111]">Result</th>
              </tr>
            </thead>
            <tbody>
              {#each displayList as item,index}
              <tr on:click={() => handleViewData(item)} class="border-y border-gray-800 odd:bg-[#111111] sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#111111] border-b-[#111111] cursor-pointer">
        ...
        {:else}
        <div class="shadow-lg shadow-bg-[#111111] bg-[#111111] sm:bg-opacity-[0.5] text-sm sm:text-[1rem] rounded-md w-full p-4 min-h-24 mt-4 text-white m-auto flex justify-center items-center text-center font-semibold">
...
<label for="clinicalDesktopModal" class="hidden lg:modal modal-bottom sm:modal-middle cursor-pointer">
  ...
  <label class="modal-box w-full relative bg-[#111111] h-auto max-h-[900px] overflow-y-scroll">
    <label for="clinicalDesktopModal" class="cursor-pointer absolute right-5 top-2 bg-[#111111] text-2xl text-white">
      ✕
    </label>
    ...
    <p class="py-4 text-gray-200 bg-[#111111] w-full">
      <span class="font-semibold text-white">Brief Summary:</span>
      {trialSummary}

    </p>

    <table class="table table-sm table-compact bg-[#111111] w-full mt-5 mb-10 text-white">
      <tbody>
        <!-- row 1 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">NCT Number</td>
          <td class="bg-[#111111] ">{trialId}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Start Date</td>
          <td class="bg-[#111111] ">{trialStart}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">End Date</td>
          <td class="bg-[#111111] ">{trialEnd}</td>
        </tr>
        <!-- row 2 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Study Status</td>
          <td class="bg-[#111111] ">{trialStage}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Phase Status</td>
          <td class="bg-[#111111] ">{trialPhase}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Study Results</td>
          <td class="bg-[#111111] ">{trialResult}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Sex</td>
          <td class="bg-[#111111] ">{formatString(trialSex)}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Age</td>
          <td class="bg-[#111111] ">{formatString(trialAge)?.replace('Older_adult', 'Older Adult')}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Sponsor</td>
          <td class="bg-[#111111] ">{trialSponsor}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Enrollment</td>
          <td class="bg-[#111111] ">{trialEnrollment}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Study Type</td>
          <td class="bg-[#111111] ">{trialStudyType}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Funder Type</td>
          <td class="bg-[#111111] ">{trialFunderType}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#111111] font-semibold ">Website</td>
          <td class="bg-[#111111] "><a class="text-[#FFBE00] sm:hover:text-white" href={trialLink} rel="noopener noreferrer" target="_blank">{trialLink}</a></td>
        </tr>
      </tbody>
    </table>
...
<div class="lg:hidden drawer drawer-end z-40 overflow-hidden w-screen">
  ...
  <div class="w-full overflow-hidden overflow-y-scroll p-2">
    ...
    <table class="table table-sm table-compact w-full mt-5 mb-10 text-white">
      <tbody>
        <!-- row 1 -->
        <tr class="border-b border-slate-700 odd:bg-[#111111]">
          <td class="font-semibold w-full">NCT Number</td>
          <td class="">{trialId}</td>
        </tr>
        <tr class="border-b border-slate-700 odd:bg-[#111111] even:bg-[#111111]">
