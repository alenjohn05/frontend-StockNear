...
<section class="overflow-hidden text-white h-full pb-8">
    <main class="overflow-hidden ">
        ...
        <div class="pb-2 rounded-lg bg-[#131722]">
          ...
          <table class="table table-sm table-compact table-pin-rows table-pin-cols w-full">
            <thead>
              <tr class="border-b border-blue-400">
                <th class="text-white shadow-md font-semibold text-sm text-start bg-[#131722]">Drug</th>
                <th class="text-white shadow-md font-semibold text-sm text-start bg-[#131722]">Stage</th>
                <th class="text-white shadow-md font-semibold text-sm text-center bg-[#131722]">Phase Status</th>
                <th class="text-white shadow-md font-semibold text-sm text-end bg-[#131722]">Result</th>
              </tr>
            </thead>
            <tbody>
              {#each displayList as item,index}
              <tr on:click={() => handleViewData(item)} class="border-y border-gray-800 odd:bg-[#131722] sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#131722] border-b-[#131722] cursor-pointer">
...
<label for="clinicalDesktopModal" class="hidden lg:modal modal-bottom sm:modal-middle cursor-pointer">
  ...
  <label class="modal-box w-full relative bg-[#131722] h-auto max-h-[900px] overflow-y-scroll">
    <label for="clinicalDesktopModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-2xl text-white">
      ✕
    </label>
    ...
    <table class="table table-sm table-compact bg-[#131722] w-full mt-5 mb-10 text-white">
      <tbody>
        ...
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">NCT Number</td>
          <td class="bg-[#131722] ">{trialId}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Start Date</td>
          <td class="bg-[#131722] ">{trialStart}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">End Date</td>
          <td class="bg-[#131722] ">{trialEnd}</td>
        </tr>
        <!-- row 2 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Study Status</td>
          <td class="bg-[#131722] ">{trialStage}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Phase Status</td>
          <td class="bg-[#131722] ">{trialPhase}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Study Results</td>
          <td class="bg-[#131722] ">{trialResult}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Sex</td>
          <td class="bg-[#131722] ">{formatString(trialSex)}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Age</td>
          <td class="bg-[#131722] ">{formatString(trialAge)?.replace('Older_adult', 'Older Adult')}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Sponsor</td>
          <td class="bg-[#131722] ">{trialSponsor}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Enrollment</td>
          <td class="bg-[#131722] ">{trialEnrollment}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Study Type</td>
          <td class="bg-[#131722] ">{trialStudyType}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Funder Type</td>
          <td class="bg-[#131722] ">{trialFunderType}</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Website</td>
          <td class="bg-[#131722] "><a class="text-[#FFBE00] sm:hover:text-white" href={trialLink} rel="noopener noreferrer" target="_blank">{trialLink}</a></td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="w-full overflow-hidden overflow-y-scroll p-2">
    ...
    <table class="table table-sm table-compact w-full mt-5 mb-10 text-white">
      <tbody>
        ...
        <tr class="border-b border-slate-700 odd:bg-[#131722] even:bg-[#131722]">
