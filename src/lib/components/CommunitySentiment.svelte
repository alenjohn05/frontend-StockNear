...
<div class="space-y-3 overflow-hidden">
    ...
    <div class="flex flex-row items-center gap-x-3 sm:gap-x-4 w-full">
        <label on:click={() => updateSentiment('upvote')} class="{alreadyVoted === 'upvote' ? 'bg-[#31528C]' : 'bg-[#2A2E39] sm:hover:bg-[#383838] sm:transition sm:duration-100 sm:ease-out'} cursor-pointer text-gray-100 px-3 py-2 w-fit rounded-lg flex flex-row items-center">
        ...
        <label on:click={() => updateSentiment('downvote')} class="{alreadyVoted === 'downvote' ? 'bg-[#BC111A]' : 'bg-[#2A2E39] sm:hover:bg-[#383838] sm:transition sm:duration-100 sm:ease-out'} cursor-pointer text-gray-100 px-3 py-2 w-fit rounded-lg flex flex-row items-center border border-[#2A2E39]">
