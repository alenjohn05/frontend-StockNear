                            ...
                            <div class="w-full rounded-full flex justify-center items-center">
                                <div class="flex flex-col items-center w-full">
                                    ...
                                    {#each (showFullStats ? geographicList : geographicList?.slice(0,3)) as item,index}
                                        ...
                                        <div class="shadow-lg bg-[#131722] w-full rounded-lg p-4 sm:p-3 mb-5  flex flex-row items-center {index === 0 ? 'mt-4' : ''} {index === 2 && !showFullStats && geographicList?.length > 2 ? 'opacity-[0.3]' : '' }">

                                            <div class="mr-3 rounded-full w-8 h-8 sm:w-10 sm:h-10 relative bg-[#131722]">
