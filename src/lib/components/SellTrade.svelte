    ...
    <div class="flex flex-col w-full">
        ...
        {#if displayTab === 'changeOrder'}
            ...
            <div class="flex justify-between items-center mt-8 w-full">
                <div class="flex flex-col sm:flex-row text-[#FFBE00] text-sm font-medium">
        ...
        <table class="table table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
            ...
            <div class="max-w-lg pt-10 m-auto pb-5 flex flex-row justify-center items-center">
                ...
                <button on:click={handleSellOrder} class="w-3/4 btn bg-[#131722] hover:bg-[#fff] hover:text-black border border-slate-500 btn-md rounded-lg text-white font-bold text-md">
                        Sell
                </button>
            </div>
            ...
            <div class="flex flex-col w-full mt-14">
                ...
                <table class="table table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                    ...
                    <div class="w-5/6 max-w-lg pt-10 m-auto pb-5 flex flex-col items-center">
                        ...
                        <button on:click={handleSellOrder} class="mt-6 btn bg-[#131722] hover:bg-[#fff] hover:text-black border border-slate-500 btn-md w-full rounded-lg m-auto text-white font-bold text-md">
                            Sell Order
                        </button>
                    </div>
