...
>
  <div class="container mx-auto px-3">
    <div class="w-full flex flex-col md:flex-row py-6">
      <div class="flex-1 mb-8">
        <div class="flex flex-row items-center mt-4">
          <a
            href="https://www.ko-fi.com/octopi"
          ...
          <a
            href="https://twitter.com/intent/follow?screen_name=octopi"
            rel="noopener noreferrer"
            target="_blank"
            class="flex flex-row items-center"
          >
      ...
      <div class="flex-1 mb-2 sm:mb-0">
        <p class="uppercase text-slate-100 font-bold text-sm md:mb-6">
          Products
        </p>
        <ul class="list-reset mb-6">
          <li class="mt-2 inline-block mr-2 md:block md:mr-0">
            <a
              href="/pricing"
              class="no-underline hover:underline text-gray-300 hover:text-yellow-400 text-xs"
              >Pricing</a
            >
          </li>
          <!-- <li class="mt-2 inline-block mr-2 md:block md:mr-0" >
      ...
      <div class="flex-1 mb-2 sm:mb-0">
        <p class="uppercase text-slate-100 md:mb-6 font-bold text-sm">
          Company
        </p>
        <ul class="list-reset mb-6">
          <li class="mt-2 inline-block mr-2 md:block md:mr-0">
    ...
    <div class="hidden sm:flex flex-col">
      ...
      <span
        class="flex text-xs flex-row items-center mt-6 text-md text-gray-300 mb-5 code-font font-bold"
      >
