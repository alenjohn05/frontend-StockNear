...
<script lang='ts'>
 ...
 <!--Footer-->
 <footer class="bg-[#131722] border-t border-slate-800 z-20 sm:z-50 relative bottom-0 left-0 w-full">
    ...
    <div class="w-full flex flex-col md:flex-row py-6">
      <div class="flex-1 mb-8">
        <div class="flex flex-row items-center mt-4">
          ...
          <a href="https://www.ko-fi.com/octopi" rel="noopener noreferrer" target="_blank" class="flex flex-row items-center">
          ...
          <a href="https://twitter.com/intent/follow?screen_name=octopi" rel="noopener noreferrer" target="_blank" class="flex flex-row items-center">
          ...
          <a href="https://github.com/octopi" rel="noopener noreferrer" target="_blank" class="flex flex-row items-center ml-3">
      ...
      <div class="flex-1">
        ...
        <ul class="list-reset mb-6">
          ...
          <li class="mt-6 sm:mt-2 inline-block mr-2 md:block md:mr-0">
            <a href="https://play.google.com/store/apps/details?id=com.octopi.bundleId" rel="noopener noreferrer" target="_blank" class="flex flex-row items-center no-underline text-white">
