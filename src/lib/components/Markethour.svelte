...
<label for="{$screenWidth > 640 ? 'marketHour' : ''}" class="cursor-pointer">
  {#if $isOpen}
  <div class="sm:border sm:border-slate-800 bg-[#131722] sm:hover:bg-[#333333] sm:ease-in-out sm:duration-100 rounded-2xl pl-3 pr-3 pt-1 pb-1 flex flex-row items-center">
...
<Drawer.Root>
  ...
  <Drawer.Trigger>
      <label for="extendedHoursInfo" class="ml-2 shadow-lg cursor-pointer rounded-full w-7 h-7 relative sm:border sm:border-slate-800 bg-[#131722] sm:hover:bg-[#333333] flex items-center justify-center border border-slate-800">
    ...
    <Drawer.Portal>
      ...
      <Drawer.Content class="fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-[#131722]">
        <div class="flex-1 rounded-t-[10px] bg-[#131722] p-4">
...
<label for="marketHour" class="modal modal-bottom sm:modal-middle cursor-pointer">
  ...
  <label class="modal-box w-full relative bg-[#131722] h-auto">
    <label for="marketHour" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-2xl text-white">
      ✕
    </label>
    ...
    <table class="table table-sm table-compact bg-[#131722] w-full mt-5 mb-10 text-white">
      ...
      <thead>
        <tr class="border-b border-slate-700">
          <th class="bg-[#131722] text-white text-sm font-semibold">
            Exchange holidays
          </th>
          <th class="bg-[#131722] text-white text-sm font-semibold">
            Date
      ...
      <tbody>
        <!-- row 1 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold "> New Years Day</td>
          <td class="bg-[#131722] ">01.01.2024</td>
        </tr>
        <!-- row 2 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Martin Luther King, Jr. Day</td>
          <td class="bg-[#131722] ">15.01.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Washington's Birthday</td>
          <td class="bg-[#131722] ">19.02.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">
            Good Friday
            </td>
          <td class="bg-[#131722]">29.03.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Memorial Day</td>
          <td class="bg-[#131722] ">27.05.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Juneteenth National Independence Day</td>
          <td class="bg-[#131722] ">19.06.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Independence Day</td>
          <td class="bg-[#131722] ">04.07.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Labor Day</td>
          <td class="bg-[#131722] ">02.09.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Thanksgiving Day</td>
          <td class="bg-[#131722] ">28.11.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#131722] font-semibold ">Christmas</td>
          <td class="bg-[#131722] ">25.12.2024</td>
        </tr>
      </tbody>
    </table>
