...
<label for="{$screenWidth > 640 ? 'marketHour' : ''}" class="cursor-pointer">
  {#if $isOpen}
  <div class="sm:border sm:border-slate-800 bg-[#0d1117] sm:hover:bg-[#333333] sm:ease-in-out sm:duration-100 rounded-2xl pl-3 pr-3 pt-1 pb-1 flex flex-row items-center">
...
<Drawer.Root>
  ...
  <Drawer.Trigger>
      <label for="extendedHoursInfo" class="ml-2 shadow-lg cursor-pointer rounded-full w-7 h-7 relative sm:border sm:border-slate-800 bg-[#0d1117] sm:hover:bg-[#333333] flex items-center justify-center border border-slate-800">
    ...
    <Drawer.Portal>
      ...
      <Drawer.Content class="fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-[#0d1117]">
        <div class="flex-1 rounded-t-[10px] bg-[#0d1117] p-4">
...
<input type="checkbox" id=extendedHoursInfo class="modal-toggle" />
    ...
    <dialog id=extendedHoursInfo class="modal modal-middle">
      ...
      <label for=extendedHoursInfo class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
...
<label for="marketHour" class="modal modal-bottom sm:modal-middle cursor-pointer">
  ...
  <label class="modal-box w-full relative bg-[#0d1117] h-auto">
    <label for="marketHour" class="cursor-pointer absolute right-5 top-2 bg-[#0d1117] text-2xl text-white">
      ✕
    </label>
    ...
    <table class="table table-sm table-compact bg-[#0d1117] w-full mt-5 mb-10 text-white">
      ...
      <thead>
        <tr class="border-b border-slate-700">
          <th class="bg-[#0d1117] text-white text-sm font-semibold">
            Exchange holidays
          </th>
          <th class="bg-[#0d1117] text-white text-sm font-semibold">
            Date
      ...
      <tbody>
        <!-- row 1 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold "> New Years Day</td>
          <td class="bg-[#0d1117] ">01.01.2024</td>
        </tr>
        <!-- row 2 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Martin Luther King, Jr. Day</td>
          <td class="bg-[#0d1117] ">15.01.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Washington's Birthday</td>
          <td class="bg-[#0d1117] ">19.02.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">
            Good Friday
            </td>
          <td class="bg-[#0d1117]">29.03.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Memorial Day</td>
          <td class="bg-[#0d1117] ">27.05.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Juneteenth National Independence Day</td>
          <td class="bg-[#0d1117] ">19.06.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Independence Day</td>
          <td class="bg-[#0d1117] ">04.07.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Labor Day</td>
          <td class="bg-[#0d1117] ">02.09.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Thanksgiving Day</td>
          <td class="bg-[#0d1117] ">28.11.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#0d1117] font-semibold ">Christmas</td>
          <td class="bg-[#0d1117] ">25.12.2024</td>
        </tr>
      </tbody>
    </table>
