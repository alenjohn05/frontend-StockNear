...
<div class="sm:hidden fixed z-50 w-full h-16 max-w-3xl -right-5 bottom-5">
  <div class="h-full max-w-3xl mx-auto">        
    <div class="flex items-center justify-end mr-10">
      <label id="animated-label" on:click={handleClick} class="inline-flex items-center justify-center w-14 h-14 font-medium bg-[#161b22] bg-opacity-[0.8] rounded-full cursor-pointer">
