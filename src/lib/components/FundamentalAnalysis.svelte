        ...
        <main class="overflow-hidden ">
            ...
            <div class="w-full mt-5 mb-5 flex justify-start items-center">
                <div class="w-full grid grid-cols-2 lg:grid-cols-3 gap-y-3 gap-x-3 ">
                  ...
                  <div class="flex flex-row items-center flex-wrap w-full px-3 sm:px-5 bg-[#111111] shadow-lg rounded-2xl h-20">
                      <div class="flex flex-col items-start">
                          ...
                          {:else}
                          <a href="/pricing" class="text-[#FFBE00] mt-1 hover:text-white font-medium text-sm flex justify-center items-center">
                            Unlock with Pro
            ...
            <div class="text-white text-sm sm:text-[1rem] mt-4 sm:mt-7 ml-1">
              ...
              {:else}
              <a href="/pricing" class="text-[#FFBE00] mt-1 hover:text-white font-medium text-sm">
