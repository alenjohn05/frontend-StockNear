...
<div class="absolute inset-0 bg-cover object-fill bg-center bg-[#0d1117]">
</div>
...
/>
  ...
  <div class="z-20 bg-center bg-[#0d1117] rounded-full w-11 h-11 bg-opacity-60 absolute bottom-2 left-2 flex items-center justify-center">
    {#if isVideoMuted[id]}
