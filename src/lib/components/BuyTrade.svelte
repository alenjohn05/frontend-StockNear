<script lang='ts'>
    ...
    <dialog id="buyTradeModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <div class="modal-box rounded-none w-full bg-[#0d1117] h-[500px]" >
        ...
        <div class="flex flex-col w-full">
            ...
            <div class= "flex flex-col">
                <div class="text-white text-md flex flex-col flex-shrink-0">
                    <div class="rounded-full w-10 h-10 relative bg-[#0d1117] mb-2">
            ...
            <table class="table table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                ...
                <div class="max-w-lg pt-10 m-auto pb-5 flex flex-row justify-center items-center">
                    ...
                    <button on:click={handleBuyOrder} class="w-3/4 btn bg-[#0d1117] hover:bg-[#fff] hover:text-black border border-slate-500 btn-md rounded-lg text-white font-bold text-md">
                            Buy
                    </button>
                </div>
                ...
                <div class="flex flex-col w-full mt-14">
                    ...
                    <table class="table table-sm table-compact mt-3 text-start flex justify-start items-center w-full px-3 m-auto">
                        ...
                        <div class="w-5/6 max-w-lg pt-10 m-auto pb-5 flex flex-col items-center">
                            ...
                            <button on:click={handleBuyOrder} class="mt-6 btn bg-[#0d1117] hover:bg-[#fff] hover:text-black border border-slate-500 btn-md w-full rounded-lg m-auto text-white font-bold text-md">
                                Buy Order
                            </button>
                        </div>
