...
<div class="space-y-3 sm:pt-5">  
  ...
  <div class="bg-[#0d1117] h-auto w-screen">
    ...
    <!--Start Header-->
    <div class="bg-[#0d1117] w-full p-1 flex flex-col items-center pb-5 h-auto">
    ...
    {#if isLoaded}
      ...
      <div class="mt-5 w-full">
        ...
        {#each displayList as item}
          <div class="flex flex-col justify-center m-auto items-start rounded-md bg-[#0d1117] shadow-lg h-auto w-11/12 mb-3" transition:fade={{ delay: 0, duration: 80 }} in={accordionOpen[item?.year]}>
            
          
            <div class="flex flex-row items-center w-full p-3">

                <div class="flex-shrink-0 mr-2 rounded-full w-12 h-12 relative bg-[#0d1117]">
            ...
            {#each item?.data as entry}
              <div class="shadow-lg bg-[#0d1117] bg-opacity-[0.5] w-11/12 rounded-md p-4 mb-3 m-auto flex flex-row justify-center items-center">
