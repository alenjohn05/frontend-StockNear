...
<section class="overflow-hidden text-white h-full pb-8 sm:pb-2">
    <main class="overflow-hidden ">
                ...
                <div class="no-scrollbar flex justify-start items-center w-screen sm:w-full mt-6 m-auto rounded-none sm:rounded-lg overflow-hidden overflow-x-scroll">
                    <table class="table table-sm shaodow table-pin-cols table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111]">
                        <thead class="">
                        <tr class="">
                            <th class="bg-[#111111] border-b border-[#000] text-white font-semibold text-sm text-start">Year</th>
                            {#each ($screenWidth >= 640 ? xData?.slice(-6) : xData) as item}
                            <td class="z-20 bg-[#111111] border-b border-[#000] text-white font-semibold text-sm text-center bg-[#111111]">{'FY'+item}</td>
                            {/each}
                        ...
                        <tbody class="shadow-md">
                            ...
                            <tr class="bg-[#111111] border-b-[#111111]">
                                <th class="text-white text-start font-medium bg-[#111111] border-b border-[#141720]">
                                    Forecast
                                </th>
                                {#each ($screenWidth >= 640 ? tableDataForecast?.slice(-6) : tableDataForecast) as item}
                                    <td class="text-white text-center font-medium  border-b border-[#141720]">
                            ...
                            <tr class="bg-[#111111] border-b-[#111111]">
                                <th class="bg-[#111111] text-white text-start font-medium  bg-[#111111] border-b border-[#141720]">
                                    Actual
                                </th>
                                {#each ($screenWidth >= 640 ? tableDataActual?.slice(-6) : tableDataActual) as item}
                                    <td class="text-white text-center font-medium bg-[#111111]">
                                        {(item?.val === '0.00' || item?.val === null) ? '-' : item?.val}
                                    </td>
                                {/each}
