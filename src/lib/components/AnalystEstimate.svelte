...
<section class="overflow-hidden text-white h-full pb-8 sm:pb-2">
    <main class="overflow-hidden ">
                ...
                <div class="no-scrollbar flex justify-start items-center w-screen sm:w-full mt-6 m-auto rounded-none sm:rounded-lg overflow-hidden overflow-x-scroll">
                    <table class="table table-sm shaodow table-pin-cols table-compact rounded-none sm:rounded-md w-full bg-[#0d1117] border-bg-[#0d1117]">
                        <thead class="">
                        <tr class="">
                            <th class="bg-[#0d1117] border-b border-[#000] text-white font-semibold text-sm text-start">Year</th>
                            {#each ($screenWidth >= 640 ? xData?.slice(-6) : xData) as item}
                            <td class="z-20 bg-[#0d1117] border-b border-[#000] text-white font-semibold text-sm text-center bg-[#0d1117]">{'FY'+item}</td>
                            {/each}
                        ...
                        <tbody class="shadow-md">
                            ...
                            <tr class="bg-[#0d1117] border-b-[#0d1117]">
                                <th class="text-white text-start font-medium bg-[#0d1117] border-b border-[#141720]">
                                    Forecast
                                </th>
                            ...
                            <tr class="bg-[#0d1117] border-b-[#0d1117]">
                                <th class="bg-[#0d1117] text-white text-start font-medium  bg-[#0d1117] border-b border-[#141720]">
                                    Actual
                                </th>
                                {#each ($screenWidth >= 640 ? tableDataActual?.slice(-6) : tableDataActual) as item}
                                    <td class="text-white text-center font-medium bg-[#0d1117]">
                                        {(item?.val === '0.00' || item?.val === null) ? '-' : item?.val}
                                    </td>
                                {/each}
