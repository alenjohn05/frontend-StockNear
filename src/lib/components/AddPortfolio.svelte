...
<dialog id="addPortfolio" class="modal modal-bottom sm:modal-middle overflow-hidden">
  ...
  <label for="addPortfolio"  class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
    ...
    <div class="flex flex-col w-full mt-10 sm:mt-0">
      ...
      <div class="text-white text-sm border bg-[#2A2E39] border-gray-800 p-3 rounded-lg overflow-y-scroll h-56">
        ...
        <ol class="text-white list-decimal ml-3 p-2">
          ...
          <li class="p-1">
            Furthermore, the <a href="/imprint" class="text-[#FFBE00] hover:underline">Imprint</a>, <a href="/terms-of-use" class="text-[#FFBE00] hover:underline">
              Terms of Use
            </a> and our 
            <a href="/privacy-policy" class="text-[#FFBE00] hover:underline">
              Privacy Policy
            </a>
            apply. 
      ...
      <form
        ...
        >
        <button type="submit" class="btn bg-[#161b22] hover:bg-purple-500  btn-md w-full rounded-lg m-auto text-white font-bold text-md">
            Create Portfolio
        </button>
      </form>
      {:else}
      <div class="w-full max-w-lg pt-5 m-auto pb-8">
        <label class="opacity-[0.4] cursor-not-allowed btn bg-[#161b22]  btn-md w-full rounded-lg m-auto text-white font-bold text-md">
          {#if !isClicked} 
            Create Portfolio
          {:else}
...
<!--Start Drawer Sidewise for mobile-->
  ...
  <div class="drawer drawer-end overflow-hidden w-screen" style="z-index: 9999;">
    ...
    <div class="drawer-side overflow-y-scroll overflow-hidden">
      ...
      <div class="bg-[#0d1117] min-h-screen px-5 pt-16 w-screen pb-20 overflow-y-scroll overflow-hidden">
      ...
      <div class="text-white text-sm border bg-[#0d1117]  border-gray-800 p-3 rounded-lg overflow-y-scroll h-56">
