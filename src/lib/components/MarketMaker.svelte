      ...
      <h2 class="mt-10 mr-1 flex flex-row items-center text-white text-xl sm:text-2xl font-bold mb-3">
        ...
        <div class="flex justify-start items-center w-full m-auto ">
          <table class="w-full" data-test="statistics-table">
            <tbody>
                <tr class="border-y border-gray-800 odd:bg-[#131722]">
          ...
          <table class="table table-sm table-compact w-full">
            <thead>
              <tr class="border-b border-blue-400">
                <th class="text-white shadow-md font-semibold text-sm text-start bg-[#131722]">Name</th>
                <th class="text-white shadow-md font-semibold text-sm text-end bg-[#131722]">Trade Count</th>
                <th class="text-white shadow-md font-semibold text-sm text-end bg-[#131722]">Share Quantity</th>
                <th class="text-white shadow-md font-semibold text-sm text-end bg-[#131722]">Notional Sum</th>
              </tr>
            </thead>
            <tbody>
              {#each (showFullStats ? topMarketMakers?.slice(0,10) : topMarketMakers?.slice(0,3)) as item,index}
              <tr class="border-y border-gray-800 odd:bg-[#131722] {index === 2 && !showFullStats && topMarketMakers?.length > 3 ? 'opacity-[0.5]' : '' } sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#131722] border-b-[#131722]">
