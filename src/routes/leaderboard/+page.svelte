...
<svelte:head>
  ...
  <!-- Add more Twitter meta tags as needed -->
    ...
    -->
      ...
      <div class="w-full max-w-4xl m-auto sm:bg-[#131722]  sm:rounded-xl h-auto p-10 mt-3">
    ...
    {#if isLoaded}
      ...
      {#each (leaderboard?.length >=3 ? leaderboard?.slice(3,-1) : leaderboard)  as item,index }
        ...
        <div class="shadow-lg bg-[#131722] w-full rounded-lg p-4 sm:p-3 flex flex-row items-center ">
          ...
          <div class="flex flex-row items-center">   
            ...
            <div class="flex-shrink-0 mr-3 rounded-full w-12 h-12 relative bg-[#131722]">
      ...
      <table class="hidden sm:table table-sm table-compact shadow-md rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto mt-4 mb-10">
        <thead>
            <tr class="">
        ...
        <tbody class="shadow-md">
            ...
            {#each (leaderboard?.length >=3 ? leaderboard?.slice(3,-1) : leaderboard) as item,index}
            <tr class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] cursor-pointer">
