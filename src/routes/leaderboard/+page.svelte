...
<svelte:head>
  ...
  <!-- Add more Twitter meta tags as needed -->
    ...
    -->
      ...
      <div class="w-full max-w-4xl m-auto sm:bg-[#0d1117]  sm:rounded-xl h-auto p-10 mt-3">
    ...
    {#if isLoaded}
      ...
      {#if leaderboard?.length ===0}
        ...
        <a href={data?.user ? '/portfolio' : '/login'} rel="noopener noreferrer" class="w-64 flex mb-5 justify-center items-center m-auto btn text-white bg-[#161b22] hover:bg-purple-500 transition duration-150 ease-in-out group">
          Get Started 
      ...
      {#each (leaderboard?.length >=3 ? leaderboard?.slice(3,-1) : leaderboard)  as item,index }
        ...
        <div class="shadow-lg bg-[#0d1117] w-full rounded-lg p-4 sm:p-3 flex flex-row items-center ">
          ...
          <div class="flex flex-row items-center">   
            ...
            <div class="flex-shrink-0 mr-3 rounded-full w-12 h-12 relative bg-[#0d1117]">
      ...
      <table class="hidden sm:table table-sm table-compact shadow-md rounded-none sm:rounded-md w-full bg-[#0d1117] border-bg-[#0d1117] m-auto mt-4 mb-10">
        <thead>
            <tr class="">
        ...
        <tbody class="shadow-md">
            ...
            {#each (leaderboard?.length >=3 ? leaderboard?.slice(3,-1) : leaderboard) as item,index}
            <tr class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#0d1117] cursor-pointer">
