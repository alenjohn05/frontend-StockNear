...
<section
  class="container w-full max-w-7xl m-auto sm:bg-[#09090b] sm:rounded-xl h-auto pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8 min-h-screen"
>
  ...
  <div class=" mt-5">
    <div class="flex flex-row items-start justify-between">
      ...
      <div
        class="flex items-center justify-center bg-[#141417] rounded border border-[#141417]"
      >
        <h1
          class="text-xs sm:text-xs text-slate-300 text-start px-2 border-r border-[#141417]"
        >
          The Changes made in
        </h1>
        <select
          class="text-white bg-[#141417] p-1 text-xs rounded border border-[#141417]"
