		...
		<div  class="flex flex-col w-full min-h-screen p-2 pt-10 pb-40">
			<div class="w-full">
				...
				>
					...
					<div class="w-full max-w-3xl sm:max-w-2xl pt-10 flex justify-center items-center m-auto pb-5 bg-[#0d1117]"  style="top: 4rem;">
						...
						<div class="flex flex-col items-center mr-5 sm:mr-10">
						  <label class="tab font-semibold hover:text-gray-300 {postType === 'text' ? 'text-gray-200' : 'text-[#9A9996]'}" on:click={() => changePostType('text')}>
							...
							<div class="{postType === 'text' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} h-1 w-[5rem]" />
					   </div>
					  ...
					  <div class="flex flex-col items-center mr-5">
						  ...
						  <div class="{postType === 'image' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} h-1 w-[8rem] sm:w-[6rem]" />
					   </div> 
					  ...
					  <div class="flex flex-col items-center">
						  ...
						  <div class="{postType === 'link' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} h-1 w-[2.5rem]" />
					   </div>   
					</div>
					...
					<span class="hidden sm:block text-white text-sm sm:text-[1rem] text-start w-full max-w-lg">
						Use <a href="/markdown-guide" rel="noopener noreferrer" target="_blank" class="text-[#FFBE00] sm:hover:text-white">
							Markdown
						</a> to format posts.
					</span>
					...
					<div class="w-full max-w-sm sm:max-w-lg pt-5 sm:pt-3">
						...
						<button type="submit" class="btn bg-[#161b22] hover:bg-purple-500 w-full max-w-lg normal-case text-lg mb-3">
							<span class="text-white">Post</span>
						</button>
						{:else}
						<label class="cursor-not-allowed btn bg-[#161b22]  w-full max-w-lg normal-case text-lg mb-3">
