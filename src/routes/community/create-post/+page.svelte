		...
		<div  class="flex flex-col w-full min-h-screen p-2 pt-10 pb-40">
			<div class="w-full">
				...
				>
					...
					<div class="w-full max-w-3xl sm:max-w-2xl pt-10 flex justify-center items-center m-auto pb-5 bg-[#111111]"  style="top: 4rem;">
						...
						<div class="flex flex-col items-center mr-5 sm:mr-10">
						  <label class="tab font-semibold hover:text-gray-300 {postType === 'text' ? 'text-gray-200' : 'text-[#9A9996]'}" on:click={() => changePostType('text')}>
							...
							<div class="{postType === 'text' ? 'bg-[#75D377]' : 'bg-[#111111]'} h-1 w-[5rem]" />
					   </div>
					  ...
					  <div class="flex flex-col items-center mr-5">
						  ...
						  <div class="{postType === 'image' ? 'bg-[#75D377]' : 'bg-[#111111]'} h-1 w-[8rem] sm:w-[6rem]" />
					   </div> 
					  ...
					  <div class="flex flex-col items-center">
						  ...
						  <div class="{postType === 'link' ? 'bg-[#75D377]' : 'bg-[#111111]'} h-1 w-[2.5rem]" />
					   </div>   
					</div>
