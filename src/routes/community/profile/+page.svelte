...
<body class="bg-[#131722] text-slate-200 overflow-hidden mt-10 sm:mt-5">
  ...
  <div class="flex flex-col min-h-screen overflow-hidden">
      ...
      <main class="grow">
          ...
          <section>
            ...
            <!--Start Profile Pic-->
            <div class="flex items-center justify-start mb-5 w-screen sm:w-full bg-[#131722] h-48 sm:rounded-xl border border-gray-700 sm:hover:border-gray-600">
              <form 
            ...
            <aside class="hidden lg:inline-block h-sh lg:w-1/2 lg:pr-2 xl:pr-0">
              <div class="lg:pl-5 z-20 h-full">
                    ...
                    <!-- Sidebar content -->
                      ...
                      <div class="rounded-xl bg-[#131722] h-48 w-full border border-gray-700 font-mono">
                        <!--Start Header-->
                        ...
                        <div class="w-full p-2">
                          ...
                          <table class="font-semibold table table-compact bg-[#131722] text-start flex justify-start items-center w-full px-3 m-auto">
                            <tbody class="bg-[#131722]">
                              <!-- row 1 -->
                              <tr class="text-gray-300">
                                <td class="bg-[#131722] border-b border-[#202020]">Karma: {data?.user?.karma}</td>
                                <td class="bg-[#202020 border-b border-[#202020]">Posts: {userStats?.numberOfPosts}</td>
                              </tr>
                              <!-- row 2 -->
                              <tr class="text-gray-300">
                                <td class="bg-[#131722]">Comments: {userStats?.numberOfComments}</td>
                                <td class="bg-[#131722]"></td>
                              </tr>
                            </tbody>
                          </table>
                      </div>
                    ...
                    <!--Start Badge-->
                      <div class="rounded-xl bg-[#131722] h-48 w-full border border-gray-700 mt-14">
                        <!--Start Header-->
                        <div class="ml-2 w-full p-3">
              ...
              <div class="w-full" >
                <ul class="w-full  font-medium flex flex-row items-center bg-[#131722] space-x-5 rtl:space-x-reverse py-2">
                  <li class="cursor-pointer flex flex-col items-center">
                    <label on:click={() => changeTab('post')} class="cursor-pointer px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {showTab === 'post' ? 'text-white ' : 'bg-[#131722]'}" >
                      Posts
                    </label>
                    <div class="{showTab === 'post' ? 'bg-[#75D377]' : 'bg-[#131722]'} mt-1 h-[3px] rounded-full w-[2.6rem]" />
                  </li>
                  <li class="cursor-pointer flex flex-col items-center">
                    <label on:click={() => changeTab('settings')} class="cursor-pointer px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {showTab === 'settings' ? 'text-white ' : 'bg-[#131722]'}" >
                      Settings
                    </label>
                    <div class="{showTab === 'settings' ? 'bg-[#75D377]' : 'bg-[#131722]'} mt-1 h-[3px] rounded-full w-[3.5rem]" />
                  </li>
                  <li class="cursor-pointer flex flex-col items-center">
                    <label on:click={() => changeTab('subscription')} class="cursor-pointer px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {showTab === 'subscription' ? 'text-white ' : 'bg-[#131722]'}" >
                      Subscription
                    </label>
                    <div class="{showTab === 'subscription' ? 'bg-[#75D377]' : 'bg-[#131722]'} mt-1 h-[3px] rounded-full w-[5rem]" />
                  </li>
                </ul>
              </div>
                          ...
                          <div class="md:pr-6 lg:pr-10 mt-6">
                            ...
                            <div class="flex flex-col w-full h-screen p-2">
                              ...
                              <div class="tabs pb-10 pt-10 flex flex-row items-center">
                                <label on:click={() => changeTab('personalData')} class="tab tab-sm pr-5 text-gray-400 hover:text-white {settingsTab === 'personalData' ? 'rounded text-white bg-[#333333]' : 'bg-[#131722]'}">Personal Data</label> 
                                <label on:click={() => changeTab('changePassword')} class="tab tab-sm pl-5 text-gray-400 hover:text-white {settingsTab === 'changePassword' ? 'rounded text-white bg-[#333333]' : 'bg-[#131722]'}">Change Password</label> 
                              </div>
                            ...
                            <div class="flex flex-col sm:flex-row overflow-hidden pl-5 p-0 sm:p-5">
                              ...
                              <div class="flex flex-col justify-start items-start w-full text-white">
                                ...
                                {:else}
                                <a href="/pricing" class="text-[#FFBE00] mt-5">
                  ...
                  <aside class="hidden {showTab === 'post' ? 'lg:inline-block' : 'hidden'} h-sh w-[300px] pt-[1.5rem]">
                    <div class="lg:pl-5 z-20 h-full invisible">
                          ...
                          <!-- Sidebar content -->
                            ...
                            <!--Start User Profile -->
                            <div class="space-y-6">  
                            <div class="shadow-lg rounded-md bg-[#131722] h-auto w-full md:w-80 border border-gray-700">
                              <!--Start Header-->
                              <div class="bg-[#131722] w-full p-3 ">
                              ...
                              <div class="w-full p-2 flex-1 flex flex-wrap">
                                ...
                                <table class="table table-compact bg-[#131722] text-start flex justify-start items-center w-full px-3 m-auto">
                                  <tbody class="bg-[#131722]">
                                    <!-- row 1 -->
                                    <tr class="text-gray-300">
                                      <td class="bg-[#131722] border-b border-[#202020]">Karma: {data?.user?.karma}</td>
...
<dialog id="cancelSubscriptionModal" class="modal modal-bottom sm:modal-middle">
  ...
  <label for="cancelSubscriptionModal"  class="cursor-pointer modal-backdrop bg-[#131722] bg-opacity-[0.5]"></label>
...
<dialog id="reactivateSubscriptionModal" class="modal modal-bottom sm:modal-middle">
  ...
  <label for="reactivateSubscriptionModal"  class="cursor-pointer modal-backdrop bg-[#131722] bg-opacity-[0.5]"></label>
...
<dialog id="changeSubscriptionModal" class="modal modal-bottom sm:modal-middle">
  ...
  <label for="changeSubscriptionModal"  class="cursor-pointer modal-backdrop bg-[#131722] bg-opacity-[0.5]"></label>
...
<dialog id="errorSubscriptionModal" class="modal modal-bottom sm:modal-middle">
  ...
  <label for="errorSubscriptionModal"  class="cursor-pointer modal-backdrop bg-[#131722] bg-opacity-[0.5]"></label>
