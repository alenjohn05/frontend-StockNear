                          ...
                          <div class="md:pr-6 lg:pr-10 mt-6">
                            ...
                            <div class="flex flex-col w-full h-screen p-2">
                              ...
                              >
                                ...
                                -->
                                  <div class="w-full max-w-lg pt-3">
                                    <button type="submit" class="btn bg-[#161b22] hover:bg-purple-500 text-white w-full max-w-lg normal-case">Update your data</button>
                                  </div>
                              ...
                              <Input
                                  ...
                                  <div class="w-full max-w-lg pt-3">
                                    <button type="submit" class="btn bg-[#161b22] text-white hover:bg-purple-500 w-full max-w-lg normal-case text-md">Update Password</button>
                                  </div>
                                </form>
                              {/if}
                            </div>
