...
<body class="bg-[#0d1117] text-slate-200 sm:mt-5 ">
                                ...
                                <div class="">
                                 ...
                                 <!--Start choose Hot or New Posts-->
                                  ...
                                  <div class="flex flex-col mt-4">
                                    <!-- Item -->
                                    <div class="border-t border-b sm:border border-gray-700 sm:hover:border-gray-600 rounded-none sm:rounded-md bg-[#0d1117] rounded-[4px] sm:rounded-[8px]">
                            ...
                            <div class="lg:pl-2 z-20 h-full">
                                ...
                                <!-- Sidebar content -->
                                 ...
                                 <div class="space-y-3 mb-5">  
                                  <div class="rounded-t-lg bg-[#0d1117] h-auto sm:w-96">
                                    <!--Start Header-->
                                    <div class="bg-[#0d1117] w-full p-3 rounded-t-lg">
                                  ...
                                  <!--End Header-->
                                    ...
                                    <div class="flex justify-center items-center mb-8 pt-5">
                                      <a href="/community/create-post" class="rounded-lg cursor-pointer w-11/12 py-2 h-full mt-2 text-md text-center font-semibold text-white m-auto hover:bg-[#161b22] bg-[#161b22] bg-opacity-[0.6] mb-6 duration-150">
                                        Create Post
                                      </a>
                                    </div>
                              ...
                              {#if discordData?.length !== 0}
                                <div class="space-y-3 mb-5">  
                                  <div class="bg-[#0d1117] h-auto sm:w-96 rounded-lg">
                                  ...
                                  <!--End Image-->
                                    ...
                                    <div class="flex justify-center items-center mb-8 pt-5">
                                      <a href={discordURL} rel="noopener noreferrer" target="_blank" class="rounded-lg cursor-pointer w-11/12 py-2 h-full mt-2 text-md text-center font-semibold text-white m-auto hover:bg-[#161b22] bg-[#161b22] bg-opacity-[0.6] mb-6 duration-150">
                                        Join us
                                      </a>
                                    </div>
                              ...
                              <div class="space-y-3 mt-5 pb-3">  
                                <div class="rounded-2xl bg-[#0d1117] h-96 sm:w-96">
                                  Start Header
                                  <div class="bg-[#0d1117] border-b border-slate-700 w-full p-3 rounded-t-lg ">
                                    <span class="text-white text-xl ml-1 font-semibold">
                                      Ticker Mentions
                                    </span>
                                  </div>
                                End Header
                                  ...
                                  <div class="w-full text-gray-300">
                                    <table class="table table-xs table-zebra table-compact w-full bg-[#0d1117] border-b border-[#202020]">
                                      <thead>
                                      ...
                                      <tbody class="p-3">
                                        ...
                                        <tr class="bg-[#0d1117] border-b border-[#202020] shake-ticker w-full">
                              ...
                              <!--End Ticker Mentioning-->
                               ...
                               <div class="space-y-3 mt-5 fixed sticky" style="top: 5rem;">  
                                <div class="bg-[#0d1117] sm:w-96 rounded-lg">
                                  <!--Start Header-->
                                  <div class="bg-[#0d1117] border-b border-slate-700 w-full pl-6 pr-6 pt-6 pb-4 rounded-t-lg">
                                    <span class="text-white text-xl ml-1 font-semibold">
                                      Community Rules
                                    </span>
                                  </div>
