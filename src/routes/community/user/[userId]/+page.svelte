                                      ...
                                      <table class="font-semibold table table-compact bg-[#131722] text-start flex justify-start items-center w-full px-3 m-auto">
                                        <tbody class="bg-[#131722]">
                                          ...
                                          <tr class="text-gray-300">
                                            <td class="bg-[#131722] border-b border-[#202020]">Karma: {userData?.karma}</td>
                ...
                <div class=" w-full " >
                  <ul class="w-full  font-medium flex flex-row items-center bg-[#131722] space-x-5 rtl:space-x-reverse py-2">
                    <li class="cursor-pointer flex flex-col items-center">
                      <label class="cursor-pointer px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {showTab === 'post' ? 'text-white ' : 'bg-[#131722]'}" >
                        Posts
                      </label>
