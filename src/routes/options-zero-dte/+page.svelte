...
<section class="w-full max-w-5xl overflow-hidden m-auto min-h-screen pt-5 pb-40 bg-[#0d1117]">



<div class="w-full max-w-5xl m-auto sm:bg-[#0d1117] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8">
...
<div class="w-full m-auto mb-10 bg-[#0d1117] pl-3 pr-3">
    ...
    <div class="w-full mt-5 mb-10 m-auto flex justify-center items-center">
        ...
        <div class="flex flex-row items-center flex-wrap w-full px-3 sm:px-5 bg-[#0d1117] border border-[#2a2e39] shadow-lg rounded-2xl h-20">
      ...
      {#if showMore}
      <!--Start Most Traded-->  
      <div class="flex flex-row items-center flex-wrap w-full px-3 sm:px-5 bg-[#0d1117] border border-[#2a2e39] shadow-lg rounded-lg h-20">
       <div class="flex flex-col items-start">
        ...
        <div class="mt-4 w-full overflow-x-auto">     
            <table class="table table-pin-cols table-sm table-compact">
                ...
                <tr class="">
                    ...
                    <th class="bg-[#0d1117] text-slate-200 font-semibold text-sm text-start">Symbol</th>
    ...
    {:else}
    <div class="mt-10 w-full text-center justify-center max-w-96 sm:flex sm:flex-row sm:items-center m-auto text-gray-100 bg-[#0d1117]  border border-[#2a2e39] sm:rounded-lg h-auto p-5 mb-4">
