...
<section class="w-full max-w-5xl overflow-hidden m-auto min-h-screen pt-5 pb-40 bg-[#131722]">



<div class="w-full max-w-5xl m-auto sm:bg-[#131722] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8">
        ...
        <div class="mt-4 w-full overflow-x-auto">     
            <table class="table table-pin-cols table-sm table-compact">
                ...
                <tr class="">
                    ...
                    <th class="bg-[#131722] text-slate-200 font-semibold text-sm text-start">Symbol</th>
