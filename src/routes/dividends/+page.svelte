...
>
  ...
  <div
    class="w-full max-w-4xl m-auto sm:bg-[#09090b] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8"
  >
    ...
    <div class="relative flex flex-col flex-1 overflow-hidden">
      ...
      >
        ...
        <div
          ...
          class="{previousMax
            ? 'opacity-80'
            : ''} hidden sm:flex h-16 w-48 cursor-pointer border m-auto flex bg-[#3C40F0] hover:bg-[#141417] border border-blue-600 mb-3"
        >
          <svg
        ...
        {#each weekday as day, index}
          ...
          >
            ...
            <div
              ...
              selectedWeekday
                ? 'bg-[#141417] bg-opacity-[0.6] sm:bg-[#A24D51] sm:gradient-effect'
        ...
        {#if index === selectedWeekday}
          {#if day?.length !== 0}
              ...
              <tbody>
                {#each day as item, index}
                  ...
                  <tr
                    ...
                    class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#09090b] border-b-[#09090b] cursor-pointer"
                  >
                    <th
                      class="{index % 2
                        ? 'bg-[#09090b]'
                        : 'bg-[#141417]'} border-b border-[#141417] text-gray-200"
                    >
                      <div class="flex flex-row items-center">
                        <div
                          class="flex-shrink-0 rounded-full w-9 h-9 relative bg-[#09090b] flex items-center justify-center"
                        >
                    ...
                    <td
                      class="{index % 2
                        ? 'bg-[#09090b]'
                        : 'bg-[#141417]'} text-[#FFBE00] border-b border-[#141417] font-bold"
                    >
                      {item?.SecurityName}
                    </td>
                    <td
                      class="{index % 2
                        ? 'bg-[#09090b]'
                        : 'bg-[#141417]'} text-white hidden sm:table-cell border-b border-[#141417]"
                    >
                      {item?.Purpose}
                    </td>
                    <td
                      class="{index % 2
                        ? 'bg-[#09090b]'
                        : 'bg-[#141417]'} text-center text-white hidden sm:table-cell border-b border-[#141417]"
                    >
            ...
            <div class="relative p-2 sm:hidden pt-5">
              {#each day as item}
                <div
                  class="bg-[#09090b] rounded-lg border border-slate-800 shadow-lg h-auto pb-3 pl-2 pr-2 pt-4 mb-7"
                >
                  <div class="flex flex-row items-center">
                    <div
