        ...
        {:else}
          {#each rawData as item, index}
            ...
            <tr
              class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#09090b] border-b border-[#141417] shake-ticker cursor-pointer"
            >
              <td class=" border-b-[#09090b] text-xs font-bold">
                {format(new Date(item?.Date), "dd-MM-yyyy")}
              </td>
              ...
              <td
                class=" items-center text-xs text-white border-b-[#09090b] hover:text-blue-500"
              >
                {item?.Subject}
              </td>
              <td
                class=" flex items-center text-xs justify-center text-white border-b-[#09090b] hover:text-blue-500"
              >
                {#if item?.FileURL}
