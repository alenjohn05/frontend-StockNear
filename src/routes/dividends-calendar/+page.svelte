...
<title>
  {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} Dividends Calendar · octopi
</title>
          ...
          <div class="flex justify-center w-full max-w-5xl m-auto h-full overflow-hidden">
              ...
              {#each weekday as day,index}
                {#if index === selectedWeekday}
                  {#if day?.length !== 0}
                    <table class="hidden sm:inline-table table table-sm table-compact rounded-none sm:rounded-md w-full border-[#141720] m-auto mt-4 ">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          <!-- row -->
                          <tr on:click={() => goto("/stocks/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] border-b-[#131722] cursor-pointer">
                            
                            <td class="text-[#FFBE00] border-b-[#131722]">
                              {item?.symbol}
                            </td>
                            ...
                            <td class="text-white border-b-[#131722]">
                              ...
                              <td class="text-white hidden sm:table-cell border-b-[#131722]">
                              ...
                              <td class="text-center text-white hidden sm:table-cell border-b-[#131722]">
                                {item?.date !== null ? new Date(item?.date)?.toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric', daySuffix: '2-digit' }) : '-'}
                              </td>

                              <td class="text-white border-b-[#131722] text-center">
                                <span class="text-sm">
                              ...
                              <td class="text-white text-sm text-end mr-1 border-b-[#131722]">
                      ...
                      {#each day as item}
                        <div class="bg-[#131722] rounded-lg border border-slate-800 shadow-lg h-auto pb-3 pl-2 pr-2 pt-4 mb-7">
