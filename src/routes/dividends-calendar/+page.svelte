                        ...
                        <tbody>
                          ...
                          <tr on:click={() => goto("/stocks/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] cursor-pointer">
                            ...
                            <td class="text-white border-b-[#111111]">
                              ...
                              <td class="text-white hidden sm:table-cell border-b-[#111111]">
                              ...
                              <td class="text-center text-white hidden sm:table-cell border-b-[#111111]">
                              ...
                              <td class="text-white text-sm text-end mr-1 border-b-[#111111]">
