        ...
        <div class=" w-full flex flex-row justify-center m-auto items-center pl-2 pr-2 sm:pl-0 sm:pr-0">
          ...
          {#each weekday as day,index}
            {#if index === selectedWeekday}
              {#if day?.length !== 0}
                <table class="hidden sm:inline-table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111] m-auto mt-4 ">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <!-- row -->
                      <tr on:click={() => goto("/stocks/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] cursor-pointer">
                        
                        <td class="text-[#FFBE00] border-b-[#111111] text-start">
                          {item?.symbol}
                        </td>
                    ...
                    <td class="text-white border-b-[#111111] text-center">
                      {item?.marketCap !== null ? '$' + abbreviateNumber(item?.marketCap) : '-'}
                    </td>

                    <td class="text-white hidden sm:table-cell text-center border-b-[#111111]">
                  ...
                  <div class="relative p-2 sm:hidden pt-5">
                    {#each day as item}
                    <div class="bg-[#111111] rounded-lg border border-slate-800 shadow-lg h-auto pb-5 pl-2 pr-2 pt-4 mb-7">
