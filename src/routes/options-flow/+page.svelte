...
<body class="sm:fixed h-screen m-auto w-full max-w-screen">
  <section class="w-full max-w-screen sm:max-w-screen-2xl flex justify-center items-center m-auto pt-5 bg-[#111111] ">
      ...
      <div class="w-full m-auto mb-10 pl-3 pr-3">
        ...
        {/if}
          ...
          <div class="flex flex-col sm:flex-row items-center w-full bg-[#111111] border border-[#2a2e39] rounded-lg px-3">
          ...
          <div class="sm:ml-auto w-full sm:w-fit">
            <div class="relative flex flex-col sm:flex-row items-center">
              ...
              <div class="py-2 sm:py-1.5 mb-5 sm:mb-0 flex-auto text-center bg-[#111111] rounded-lg w-full sm:w-fit">
          ...
          <div class="w-full mt-5 mb-10 m-auto flex justify-center items-center">
            ...
            {#if showMore}
             <!--Start Most Traded-->  
             <div class="flex flex-row items-center flex-wrap w-full px-5 bg-[#111111] shadow-lg rounded-lg h-20">
              <div class="flex flex-col items-start">
...
<dialog id="filterList" class="modal modal-bottom sm:modal-middle ">
  ...
  <div class="modal-box w-full bg-[#111111] border border-[#2a2e39] sm:border sm:border-slate-800 overflow-hidden rounded-md">
