<script lang='ts'>
  ...
  <div class="flex flex-col justify-center items-center p-3 sm:p-0">
    ...
    <div class="mt-0 sm:mt-5 mb-2 w-full sm:flex sm:flex-row sm:items-center m-auto text-gray-100 font-medium bg-[#131722] sm:rounded-lg h-auto p-5">
      ...
      <table class="mt-5 table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto overflow-hidden">
        ...
        <tbody>
          ...
          <tr on:click={() => goto("/stocks/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] border-b-[#131722] shake-ticker cursor-pointer">
            ...
            <td class="text-white text-sm text-start border-b-[#131722]">
          ...
          <td class="text-white border-b-[#131722] text-end flex flex-row items-center justify-end">
