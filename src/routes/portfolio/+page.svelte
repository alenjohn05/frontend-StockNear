    ...
    <div class="w-full max-w-4xl m-auto sm:bg-[#0d1117] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8">
      ...
      {#if isLoaded}
        ...
        {#if portfolio.length === 0}
          ...
          <div class="bg-[#0d1117] pt-5 pb-5 mt-5 sm:rounded-2xl border-t border-b sm:border border-slate-800">
            ...
            <div class="flex flex-row ">
              ...
              <div class="w-3/4 flex ml-auto mr-3 flex-row justify-end items-center -mt-2">
                <a href="/leaderboard" class="text-[#FFBE00] hover:text-white font-medium text-lg mr-3 sm:mr-8 hover:underline">
                  Rank: 'n/a'
                </a>
        ...
        <div class="bg-[#0d1117] border-t border-b sm:border border-slate-800 pt-5 pb-5 mt-5 sm:rounded-2xl">
      ...
      <div class="bg-[#0d1117] pt-5 pb-5 mt-10 sm:rounded-2xl">
        <div class="flex flex-row justify-between items-center">
          <div class="text-slate-300 font-bold text-lg pl-5">
            Holdings
          </div>
          <label for="holdingsCategoryInfo" class="cursor-pointer hover:underline text-[#FFBE00] font-medium text-sm mr-3">
            {displayChange}
        ...
        <table class="table table-sm table-compact  w-full m-auto mt-4">
          ...
          <tbody class="">
            ...
            <tr on:click={() => goto(`/${item?.assetType === 'etf' ? 'etf' : 'stocks'}/${item?.symbol}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] {index % 2 === 0 ? 'bg-opacity-[0.25] bg-[#323239]' : 'bg-[#0d1117]'} border-b-[#0d1117] cursor-pointer">
      ...
      <div class="bg-[#0d1117] pt-5 pb-5 mt-10 sm:rounded-2xl {!showTradingHistory ? 'shadow-md' : ''}">
        ...
        <div transition:fade={{ delay: 0, duration: 80 }} in={showTradingHistory}>
          <table class="table table-sm table-compact w-full m-auto mt-4">
            <tbody class="">
              ...
              <tr class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] {index % 2 === 0 ? 'bg-opacity-[0.25] bg-[#323239]' : 'bg-[#0d1117]'} border-b-[#0d1117] cursor-pointer">
              <td class="text-white border-b border-[#202020]">
                <div class="flex flex-row items-center">
                  <div class="flex flex-col">
                    <span class="text-[#FFBE00]">{item?.symbol}</span>
...
<!--End Login Modal-->
  ...
  <dialog id="accountValueInfo" class="modal modal-bottom sm:modal-middle ">
    ...
    <label id="accountValueInfo" for="accountValueInfo"  class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
  ...
  <dialog id="availableCashInfo" class="modal modal-bottom sm:modal-middle ">
    ...
    <label id="availableCashInfo" for="availableCashInfo"  class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
  ...
  <dialog id="overallReturnInfo" class="modal modal-bottom sm:modal-middle ">
    ...
    <label id="overallReturnInfo" for="overallReturnInfo"  class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
  ...
  <dialog id="maxDrawdownInfo" class="modal modal-bottom sm:modal-middle ">
    ...
    <div class="modal-box w-full bg-[#0d1117] border border-[#2a2e39] border border-slate-800">
  ...
  <input type="checkbox" id="holdingsCategoryInfo" class="modal-toggle" />
   ...
   <dialog id="holdingsCategoryInfo" class="modal modal-bottom sm:modal-middle ">
     ...
     <label id="holdingsCategoryInfo" for="holdingsCategoryInfo"  class="cursor-pointer modal-backdrop bg-[#0d1117] bg-opacity-[0.5]"></label>
