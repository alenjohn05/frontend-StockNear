    ...
    {#if allList?.length !== 0}
      <div class="flex flex-row items-center w-full">
        ...
        <div class="flex flex-row items-center justify-between w-full">
          <label for="allList" class="ml-2 cursor-pointer w-auto px-4 bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out flex justify-center items-center py-3 rounded-lg shadow-lg">
          ...
          <label for="addWatchList" class="{$screenWidth < 640 || !data?.user ? 'hidden' : ''} cursor-pointer w-48 md:w-44 bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out flex justify-center items-center py-3 rounded-lg shadow-lg mr-2">
      ...
      <div class ="w-full m-auto flex justify-center items-center">
        <label for="addWatchList" class="{$screenWidth < 640 || !data?.user ? 'hidden' : ''} light-box cursor-pointer w-48 md:w-44 bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out flex justify-center items-center py-3 rounded-lg shadow-lg">
...
<Drawer.Root>
      ...
      <div class="{!data?.user ? 'hidden' : ''} sm:hidden fixed w-full h-16 max-w-3xl -right-5 bottom-3">
        <div class="h-full max-w-3xl mx-auto">        
          <div class="flex items-center justify-end mr-10">
            <label class="inline-flex items-center justify-center w-14 h-14 border border-[#000] ring-[#000] bg-[#0DDE00] text-[0.95rem] font-bold rounded-full text-[#111111]">
    ...
    <Drawer.Content class="fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-[#111111]">
        <!-- Modal content -->
        <form on:submit={createWatchList}
        class="space-y-2 pt-5 pb-5 flex-1 rounded-t-[10px] bg-[#111111] p-4"
        >
...
{:else}
  ...
  <!-- Desktop modal using dialog component -->
    ...
    <dialog id="addWatchList" class="modal modal-middle">
      ...
      <label for="addWatchList" class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
...
<dialog id="settingsWatchListModal" class="modal modal-bottom sm:modal-middle">
    ...
    <label for="settingsWatchListModal"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
    
    
    <div class="modal-box w-full bg-[#111111] border border-[#2a2e39] pb-5">
...
<dialog id="editNameWatchList" class="modal modal-bottom sm:modal-middle">
    ...
    <label for="editNameWatchList"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
    
    
    <div class="modal-box w-full bg-[#111111] border border-[#2a2e39] sm:border sm:border-slate-600 " >
...
<dialog id="deleteWatchList" class="modal modal-bottom sm:modal-middle">
  ...
  <label for="deleteWatchList"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
  
  
  <div class="modal-box w-full bg-[#111111] border border-[#2a2e39] sm:border sm:border-slate-600 overflow-hidden">
...
<dialog id="allList" class="modal modal-bottom sm:modal-middle ">
  ...
  <label id="allList" for="allList"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
  ...
  <label for="allList" class="cursor-pointer absolute right-5 top-5 bg-[#111111] text-[1.8rem] text-white">
