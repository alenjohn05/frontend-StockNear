        ...
        <div class="w-full sm:-mt-6 mb-8 m-auto flex justify-center items-center p-3">
          ...
          <MiniPlot title="Russel 2000" priceData = {priceDataRussel2000} changesPercentage={changeRussel2000} previousClose={previousCloseRussel2000}/>
            ...
            <div class="flex flex-row justify-end items-center pr-4 sm:pr-0 pb-2">
                {#if editMode}
                <label on:click={handleDelete} class="cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out px-4 py-2 rounded-lg shadow-lg mr-3">
                ...
                {/if}
                <label on:click={() => editMode = !editMode} class="cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out px-4 py-2 rounded-lg shadow-lg">
            ...
            <div class="w-screen sm:w-full rounded-lg overflow-hidden overflow-x-scroll no-scrollbar">
                <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111] m-auto mt-4 ">
                  <!-- head -->
                  <thead>
                    <tr class="">
                  ...
                  <tbody class="p-3">
                    ...
                    <!-- row -->
                    <tr on:click={() => stockSelector(item?.symbol, item?.assetType)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] cursor-pointer">
                      
                      <td on:click={() => handleFilter(item?.id)} class="hidden sm:table-cell text-[#FFBE00] font-medium text-sm text-start border-b-[#111111] flex flex-row items-center">
                      ...
                      <td on:click={() => handleFilter(item?.id)} class="text-gray-200 border-b-[#111111]">
                    ...
                    <td class="hidden sm:table-cell text-white font-medium text-sm text-center border-b-[#111111]">
                    ...
                    <td class="text-white font-medium text-sm text-end border-b-[#111111]">
