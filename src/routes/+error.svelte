<script>
  ...
  import logo from "$lib/images/octopi_logo.png";
</script>
    ...
    <div class="lg:flex">
      <div class="mt-10 mb-5 m-auto">
        ...
        <!--
                ...
                -->
        <span
          class="mt-4 text-white font-medium text-md w-5/6 m-auto text-center flex justify-center items-center"
        >
        ...
        <a
          href="/"
          class="flex justify-center items-center w-5/6 m-auto py-2.5 mt-10 rounded-md bg-blue-600 hover:bg-blue-500 text-white font-medium"
        >
          Back to Home Page
        </a>
      </div>
