<script lang='ts'>
  ...
  <section class="w-full max-w-4xl overflow-hidden m-auto">
    ...
    <div class="w-full max-w-4xl m-auto text-gray-100 font-medium bg-[#111111] sm:rounded-lg h-auto p-5 mb-4">
      ...
      <div class="stats stats-horizontal no-scrollbar bg-[#111111] w-full rounded-lg text-white">
        ...
        <div class="flex justify-center w-full m-auto h-full overflow-hidden">
            ...
            <div class="relative flex flex-col flex-1 overflow-hidden">
              ...
              <table class="table table-sm sm:table-md table-compact rounded-none sm:rounded-md w-full border-bg-[#111111] m-auto mt-4 ">
                <thead>
                ...
                <tbody>
                  ...
                  <tr on:click={() => goto("/stocks/"+item?.symbol)}  class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] shake-ticker cursor-pointer">
                    ...
                    <td class="hidden sm:table-cell text-[#FFBE00] font-medium  border-b-[#111111]">
                      {item?.symbol}
                    </td>
                    ...
                    <td class="text-white font-medium text-center hidden sm:table-cell border-b-[#111111]">
