...
$: {
  ...
  charNumber = 40;
    ...
    <section class="w-full max-w-4xl overflow-hidden m-auto">
        ...
        <div class="stats stats-horizontal no-scrollbar bg-[#111111] shadow w-full rounded-lg">
              ...
              <div class="relative flex flex-col flex-1 overflow-hidden">
                ...
                <table class="table rounded-none sm:rounded-md w-full border-bg-[#111111] m-auto mt-4 ">
                    ...
                    <tbody>
                      ...
                      <!-- row -->
                      <tr class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111]">
