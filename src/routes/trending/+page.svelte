    ...
    <div class="w-full max-w-4xl m-auto sm:bg-[#0d1117] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8">
      ...
      <div class="flex justify-center w-full max-w-5xl m-auto h-full overflow-hidden">
          ...
          <div class="w-screen sm:w-full relative flex flex-col flex-1 overflow-hidden overflow-x-auto">     
            <table class="table table-sm sm:table-md table-compact rounded-none sm:rounded-md w-full border-bg-[#0d1117] m-auto mt-4 overflow-x-auto">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <!-- row -->
                  <tr on:click={() => assetSelector(item?.symbol, item?.assetType)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#0d1117] border-b-[#0d1117] shake-ticker cursor-pointer">
                    
                    <td class="text-gray-200 pb-3 text-md text-start">
                      {index+1}
                    </td>

                    <th class="text-[#FFBE00] font-normal">
                      {item?.symbol}
                    </th>
