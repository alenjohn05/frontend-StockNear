    ...
    <div class="w-full max-w-4xl m-auto sm:bg-[#111111] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8">
      ...
      <div class="flex justify-center w-full max-w-5xl m-auto h-full overflow-hidden">
          ...
          <div class="w-screen sm:w-full relative flex flex-col flex-1 overflow-hidden overflow-x-auto">     
            <table class="table table-sm sm:table-md table-compact rounded-none sm:rounded-md w-full border-bg-[#111111] m-auto mt-4 overflow-x-auto">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <!-- row -->
                  <tr on:click={() => assetSelector(item?.symbol, item?.assetType)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] shake-ticker cursor-pointer">
