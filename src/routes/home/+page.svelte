...
<div class="w-full max-w-6xl overflow-hidden m-auto min-h-screen bg-[#131722]">
                              ...
                              <div class="grid grid-cols-1 gap-10">
                                ...
                                <div >
                                  ...
                                  <div class="text-center mb-5 relative w-fit flex justify-center m-auto">
                                    <a href="/pricing" class="text-white antialiased bg-[#131722] w-full px-4 py-2 rounded-xl m-auto font-medium text-sm flex items-center">
                                  ...
                                  <div class="text-center mb-5 relative w-fit flex justify-center m-auto">
                                    <a href="/dark-pool-flow" class="text-white antialiased bg-[#131722] w-full px-4 py-2 rounded-xl m-auto font-medium text-sm flex items-center">
                                ...
                                -->
                                  ...
                                  <span class="text-center flex-1 justify-center items-center text-white text-[1rem] sm:text-lg">
                                    ...
                                    <div class="flex justify-center items-center mt-8 mb-6 m-auto w-full max-w-64 sm:max-w-3xl">
                                      <label on:click={loadSearchData} for="searchBarModal" class="shadow-lg w-96 h-10 sm:h-12 flex flex-row items-center justify-start bg-[#131722] appearance-none py-3 cursor-pointer border border-slate-600 rounded-lg">
                                  ...
                                  <!-- End Search button -->
                                    ...
                                    <div class="w-auto m-auto flex flex-row items-center justify-center mt-6 text-lg sm:text-xl">
                                      ...
                                      {#each active?.slice(0,4) as item, index}
                                        <a href={'/stocks/'+item?.symbol} class="ml-1 text-[#FFBE00] sm:hover:text-slate-100">
                                          {item?.symbol}
                                        </a>
                                        {#if index !== 3}
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10 w-full m-auto pb-14 sm:pb-20 sm:mt-10">
    ...
    <div class="hidden sm:block w-full">
      ...
      <table class="table table-sm table-pin-rows table-compact rounded-none sm:rounded-lg">
        ...
        <tbody>
          ...
          <tr on:click={() => goto("/stocks/"+item.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] shake-ticker cursor-pointer">
            <td class="text-[#FFBE00]">
                {item?.symbol}
            </td>
     ...
     <div class="sm:hidden overflow-hidden">
      ...
      <div class="w-full flex flex-row items-center mb-5 ml-3 overflow-hidden">
        <label on:click={() => scrollToItem('gainer')} class="flex flex-row items-center {trendingText === 'gainer' ? 'bg-[#333333]' : 'bg-[#131722]'} rounded-xl py-1">
        ...
        <label on:click={() => scrollToItem('loser')} class="flex flex-row items-center {trendingText === 'loser' ? 'bg-[#333333]' : 'bg-[#131722]'} rounded-xl py-1 ml-4">
        ...
        <label on:click={() => scrollToItem('active')} class="flex flex-row items-center {trendingText === 'active' ? 'bg-[#333333]' : 'bg-[#131722]'} rounded-xl py-1 ml-4">
      ...
      <div class="w-screen no-scrollbar grid grid-cols-5 gap-x-44 overflow-hidden overflow-x-scroll pl-5 pr-10">
        {#each (trendingText === 'gainer' ? gainer : trendingText === 'loser' ? loser : active) as item,index}
          <a href={"/stocks/"+item?.symbol} class="bg-[#131722] rounded-lg  h-[90px] w-36 relative">
            ...
            <div class="flex flex-row items-center justify-end p-2">
              ...
              <div class="rounded-full w-7 h-7 relative bg-[#131722] flex items-center justify-center">
    ...
    <div class="hidden sm:block w-full mt-10 lg:mt-0">
      ...
      <table class="table table-sm table-compact table-pin-rows shadow-md rounded-none sm:rounded-lg bg-[#131722]">
        <thead>
          <tr class="bg-[#131722]">
            <th class="text-white font-semibold text-sm">Symbol</th>
            <th class="text-white font-semibold text-sm">Name</th>
    ...
    <div class="w-full m-auto p-2 sm:p-0 mb-20">
      <h2 class="text-white text-xl sm:text-2xl font-bold text-start mt-5 mb-2 ml-2 ">
        Latest Market Momentum
          ...
          <div class="shadow-md bg-[#131722] border border-[#2a2e39] p-6 mb-4 rounded-lg text-start">
            <div class="text-sm text-white">
              <div class="flex flex-col items-start">
                <div class="hidden sm:flex flex-row items-center mb-3">
                  {#if latestInfoDate(item?.date)}
                    <label class="bg-[#2962ff] text-white font-medium text-xs rounded-lg px-2 py-0.5">New</label>
                  ...
                  <div class="flex flex-wrap gap-y-3 flex-row items-center">
                    {#each item?.stocks as item2}
                      <div class="mr-2 mb-2 sm:mb-0">
                        <a href={item2?.assetType === 'stock' ? `/stocks/${item2?.ticker}` : item2?.assetType === 'etf' ? `/etf/${item2?.ticker}` : ''} class="cursor-pointer w-fit bg-[#2a2e39] bg-opacity-[0.5] sm:hover:bg-opacity-[0.6] px-3 sm:px-4 py-1.5 sm:py-2 text-sm rounded-xl hover:text-white text-[#FFBE00]">
                          {item2?.ticker}
                        </a>
                      </div>
                    {/each}
