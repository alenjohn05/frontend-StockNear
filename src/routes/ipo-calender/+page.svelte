...
{:else}
  <section
    class="w-full max-w-7xl m-auto sm:bg-[#09090b] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8"
  >
    ...
    <div class="flex sm:flex-row flex-col items-center justify-between">
      ...
      <div class="bg-[#141417] mb-10 rounded border border-[#141417]">
          ...
          <tbody>
            {#each displayList as item, index}
              ...
              <tr
                ...
                <td class=" border-b-[#09090b] text-xs font-bold text-end">
                  {item?.IssuePriceMin} - {item?.IssuePriceMax
                    ? item?.IssuePriceMax
                    : ""}
                </td>
                <td class=" text-[#FFBE00] text-xs border-b-[#09090b] text-end">
        ...
        >
          ...
          <tbody>
            {#each displayList as item, index}
              ...
              >
                <td
                  class=" text-[#FFBE00] text-xs border-b-[#09090b]"
                >
                ...
                <td
                  class="  item-center justify-end text-xs text-end text-white border-b-[#09090b] hover:text-blue-500"
                >
                  {item?.IssuePriceMin} - {item?.IssuePriceMax
                    ? item?.IssuePriceMax
                    : ""}
                ...
                <td
                  class=" text-xs text-center text-white border-b-[#09090b] hover:text-blue-500 text-end"
                >
                  {format(new Date(item?.OpenDate), "dd-MM-yyyy")}
                </td>
                <td
