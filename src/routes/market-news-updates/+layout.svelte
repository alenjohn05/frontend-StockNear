<script lang="ts">
  ...
  const navigation = [
    {
      title: "Stocks",
      link: "/market-news-updates",
    },
    {
      title: "Overview",
      link: "/market-news-updates/latest-news",
    },
    {
      title: "Announcements",
      link: "/market-news-updates/result",
    },
    {
      title: "Foreign Markets",
      link: "/market-news-updates/foreign_market",
    },
    {
      title: "Corporate",
      link: "/market-news-updates/corporate",
    },
    {
      title: "Debt Market",
      link: "/market-news-updates/debt-markets",
    },
    {
      title: "Currency",
      link: "/market-news-updates/currency-news",
    },
    {
      title: "Mutual Funds",
      link: "/market-news-updates/mutual-fund",
    },
    {
      title: "Economy",
      link: "/market-news-updates/economy",
    },
    {
      title: "Derivatives",
      link: "/market-news-updates/derivatives-news",
    },
    {
      title: "Crypto",
      link: "/market-news-updates/crypto",
    },
    {
      title: "General",
      link: "/market-news-updates/general",
    },
...
<div class="container mx-auto max-w-7xl overflow-hidden">
  ...
  <main>
    <div
      class="w-full max-w-5xl m-auto sm:bg-[#09090b] sm:rounded-xl h-auto pl-10 pr-10 pt-5 sm:pb-10 sm:pt-10 mt-3 mb-8"
    >
    ...
    <div class="pl-4 pr-4 sm:pl-0 sm:pr-0 w-screen sm:w-full">
      <div
        class="tabs flex flex-row justify-between sm:justify-start items-center w-full pl-3 pr-3 sm:pl-0 sm:pr-0"
      >
          ...
          >
            ...
            <div
              ...
              item?.link + '/' === $page.url.pathname
                ? 'bg-[#75D377]'
                : 'bg-[#09090b]'} mt-1 h-[3px] rounded-full w-[3rem] rounded-full"
            />
          </a>
        {/each}
      </div>
