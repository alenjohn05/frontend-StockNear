      ...
      <div class="w-screen sm:w-full m-auto">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 pt-5">
          {#if news.length !== 0}
            {#each news as item}
              <article
                class="max-w-xl flex p-5 flex-col w-full items-start bg-[#141417]  shadow-lg h-auto sm:h-[300px] pb-10 sm:pb-5 rounded-none sm:rounded-lg m-auto"
              >
                <div
                ...
                >
                  ...
                  >
                    <div class="text-white-500 text-xs code-font">
                      Sentiment :
                    </div>
