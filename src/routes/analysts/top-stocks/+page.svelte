<script lang='ts'>
  ...
  <title>
      {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''}  Top 100 Strong Buy Stocks · octopi
  </title>
  ...
  <!-- Other meta tags -->
  <meta property="og:title" content={`Top 100 Strong Buy Stocks · octopi`}/>
  ...
  <meta name="twitter:title" content={`Top 100 Strong Buy Stocks · octopi`}/>
      ...
      <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden max-w-4xl">
          <div class="relative flex justify-center items-center overflow-hidden w-full">
              <main class="w-full">
                ...
                <div class="w-full max-w-4xl sm:flex sm:flex-row sm:items-center m-auto text-gray-100 bg-[#111111]  sm:rounded-lg h-auto p-5 ">
                ...
                <div class="w-screen sm:w-full m-auto mt-10">
                    ...
                    <div class="w-screen sm:w-full m-auto rounded-none sm:rounded-lg mb-4 overflow-x-scroll sm:overflow-hidden">
                      <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111] m-auto">
                        <thead>
                          <tr class="bg-[#111111] border-b border-blue-400">
                            <th class="text-end bg-[#111111] text-white text-sm font-semibold">
                              #
                            </th>
                            <th class="text-start bg-[#111111] text-white text-sm font-semibold">
                              Symbol
                            </th>
  
                            <th class="hidden sm:table-cell text-start bg-[#111111] text-white text-sm font-semibold">
                              Name
                            </th>
                        ...
                        <tbody>
                          ...
                          <tr on:click={() => goto(`/stocks/${item?.ticker}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''} cursor-pointer">
                            ...
                            <td class="text-sm text-start">
                                <div class="flex flex-col items-start w-32 sm:w-fit">
                                    <span class="text-[#FFBE00]">{item?.ticker}</span>
