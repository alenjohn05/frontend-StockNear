              ...
              <main class="w-full">
                ...
                <div class="w-screen sm:w-full m-auto mt-12">
                    ...
                    <div class="p-2 sm:p-0">
                      <div class="stats stats-horizontal bg-[#0d1117] rounded-lg shadow w-full rounded-none sm:rounded-lg mt-12 mb-5">
                        ...
                        <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#0d1117] border-bg-[#0d1117] m-auto">
                          <thead>
                            <tr class="bg-[#0d1117] border-b border-blue-400">
                              <th class="text-start bg-[#0d1117] text-gray-200 text-sm sm:text-[1rem] font-semibold">
                                Stock
                              </th>
                              <th class="text-start bg-[#0d1117] text-white text-sm sm:text-[1rem] font-semibold">
                                Action
                              </th>
    
                              <th class="text-end hidden sm:table-cell bg-[#0d1117] text-white text-sm sm:text-[1rem] font-semibold">
                                Price Target
                              </th>
                          ...
                          <tbody>
                            ...
                            <tr on:click={() => goto(`/stocks/${item?.ticker}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#0d1117] cursor-pointer">
