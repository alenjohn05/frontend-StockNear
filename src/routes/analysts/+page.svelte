                    ...
                    <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#0d1117] border-bg-[#0d1117] m-auto">
                      <thead>
                        <tr class="bg-[#0d1117] border-b border-blue-400">
                          <th class="text-end bg-[#0d1117] text-white text-[1rem] font-medium">
                            #
                          </th>
                          <th class="text-start bg-[#0d1117] text-white text-[1rem] font-medium">
                            Analyst
                          </th>
                      ...
                      <tbody>
                        ...
                        <tr on:click={() => goto(`/analysts/${item?.analystId}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#0d1117] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''} cursor-pointer">
                          ...
                          <td class="text-sm text-start">
                            <div class="flex flex-col items-star w-32">
                              <span class="text-[#FFBE00] text-sm font-medium">{item?.analystName} </span>
