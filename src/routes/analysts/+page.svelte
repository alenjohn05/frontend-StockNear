                    ...
                    <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto">
                      <thead>
                        <tr class="bg-[#131722] border-b border-blue-400">
                          <th class="text-end bg-[#131722] text-white text-[1rem] font-medium">
                            #
                          </th>
                          <th class="text-start bg-[#131722] text-white text-[1rem] font-medium">
                            Analyst
                          </th>
                      ...
                      <tbody>
                        ...
                        <tr on:click={() => goto(`/analysts/${item?.analystId}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''} cursor-pointer">
