                    ...
                    <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111] m-auto">
                      <thead>
                        <tr class="bg-[#111111] border-b border-blue-400">
                          <th class="text-end bg-[#111111] text-white text-[1rem] font-medium">
                            #
                          </th>
                          <th class="text-start bg-[#111111] text-white text-[1rem] font-medium">
                            Analyst
                          </th>
                      ...
                      <tbody>
                        ...
                        <tr on:click={() => goto(`/analysts/${item?.analystId}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''} cursor-pointer">
