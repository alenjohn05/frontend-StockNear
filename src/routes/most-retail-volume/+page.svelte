      ...
      <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden max-w-4xl">
          <div class="relative flex justify-center items-center overflow-hidden w-full">
              <main class="w-full">
                ...
                <div class="w-full max-w-4xl text-center sm:text-start sm:flex sm:flex-row sm:items-center m-auto text-gray-100 bg-[#131722]  sm:rounded-lg h-auto p-5 ">
                      ...
                      <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto">
                        <thead>
                          <tr class="bg-[#131722] border-b border-blue-400">
                            ...
                            <th class="text-center bg-[#131722] text-white text-sm font-semibold">
                              Daily Traded
                            </th>
                            <th class="text-end bg-[#131722] text-white text-sm font-semibold">
                              Volume in %
                        ...
                        <tbody>
                          ...
                          <tr on:click={() => goto(`/stocks/${item?.symbol}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#131722] {index+1 === stockList?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''} cursor-pointer">
