              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      class={`relative z-10 code-font code-font rounded-full ${item?.sentiment_category === "negative"?"bg-red-600":item?.sentiment_category ==="positive"?"bg-green-600":"bg-[#161b22]"} px-3 py-1.5 font-medium text-white hover:bg-purple-400`}
                    >
