...
<title>
  {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} List of All Crypto Ticker Symbols · octopi
</title>
...
<!-- Other meta tags -->
<meta property="og:title" content={`List of All Crypto Ticker Symbols · octopi`}/>
...
<meta name="twitter:title" content={`List of All Crypto Ticker Symbols · octopi`}/>
...
<!-- Add more Twitter meta tags as needed -->
        ...
        <div class="w-full max-w-4xl mt-10 m-auto mb-10 bg-[#111111] pl-3 pr-3 overflow-hidden">
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <table class="mt-5 table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#111111] border-bg-[#111111] m-auto overflow-x-scroll">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr on:click={() => goto("/crypto/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#111111] border-b-[#111111] shake-ticker cursor-pointer">
                    
                    <td class="hidden sm:table-cell text-[#FFBE00] font-medium text-sm text-start border-b-[#111111]">
                      {item?.symbol}
                    </td>
                    ...
                    <td class="text-white text-end border-b-[#111111]">
