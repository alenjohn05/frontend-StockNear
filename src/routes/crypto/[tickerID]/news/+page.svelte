...
<svelte:head>
  ...
  <title>
    {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {$displayCompanyName} ({$cryptoTicker}) latest Stock Market News and Breaking Stories · octopi
  </title>
  <meta name="description" content={`Get the latest stock market news and breaking stories of ${$displayCompanyName} (${$cryptoTicker}).`} />
  
  <!-- Other meta tags -->
  <meta property="og:title" content={`${$displayCompanyName} (${$cryptoTicker}) latest Stock Market News and Breaking Stories · octopi`}/>
  ...
  <meta name="twitter:title" content={`${$displayCompanyName} (${$cryptoTicker}) latest Stock Market News and Breaking Stories · octopi`}/>
                    ...
                    <div class="mb-6">
                        <h1 class="text-2xl sm:text-3xl text-white font-bold">
                          ...
                          {#each newsList as item}
                                <div class="flex flex-col bg-[#0d1117] rounded-lg m-auto">
                          ...
                          {:else}
                          <div class="w-screen max-w-xl sm:flex sm:flex-row sm:items-center justify-center m-auto text-gray-100 font-medium bg-[#0d1117] sm:rounded-lg h-auto p-5 mb-4">
