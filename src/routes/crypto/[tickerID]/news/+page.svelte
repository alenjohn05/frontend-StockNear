                    ...
                    <div class="mb-6">
                        <h1 class="text-2xl sm:text-3xl text-white font-bold">
                          ...
                          {#each newsList as item}
                                <div class="flex flex-col bg-[#111111] rounded-lg m-auto">
                          ...
                          {:else}
                          <div class="w-screen max-w-xl sm:flex sm:flex-row sm:items-center justify-center m-auto text-gray-100 font-medium bg-[#111111] sm:rounded-lg h-auto p-5 mb-4">
