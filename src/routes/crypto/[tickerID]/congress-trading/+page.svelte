            ...
            <div class="relative flex justify-center items-center overflow-hidden">
                  <div class="sm:p-7 sm:w-full sm:max-w-3xl m-auto mt-5 sm:mt-0">
                    <div class="mb-6">
                      ...
                      <label on:click={changeStructure} class="sm:hidden w-24 sm:ml-3 mr-2 sm:mr-0 cursor-pointer bg-[#131722] sm:hover:bg-[#131722] duration-100 transition ease-in-out px-4 py-2 rounded-lg shadow-md">
                      ...
                      <div class="mt-6 flex justify-start items-center w-full m-auto rounded-none sm:rounded-lg mb-4">
                        <table class="table table-sm sm:table-md table-compact rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto">
                          <thead>
                            <tr class="bg-[#131722]">
                              <th class="shadow-md text-start bg-[#131722] text-white text-sm font-semibold">
                                Person
                              </th>
                              <th class="shadow-md text-end bg-[#131722]  hidden sm:table-cell text-white text-sm font-semibold">
                                Transaction Date
                              </th>
                          ...
                          <tbody>
                            ...
                            <tr on:click={() => goto(`/politicians/${item?.id}`)} class="odd:bg-[#131722] sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#131722] border-b-[#131722] cursor-pointer">
    
                              <td class="text-gray-200 pb-3 border-b border-b-[#131722]">
                                ...
                                <td class="text-end hidden sm:table-cell text-xs sm:text-sm text-white border-b border-b-[#131722]">
                                    {new Date(item?.transactionDate)?.toLocaleString('en-US', { month: 'short', day: 'numeric', year: 'numeric', daySuffix: '2-digit' })}
                                </td>

                                <td class="text-end text-xs sm:text-sm text-white border-b border-b-[#131722]">
                                    {item?.amount}
                                </td>
                                <td class="text-start text-end text-sm text-white border-b border-b-[#131722]">
                                  {#if item?.type === 'Bought'}
                      ...
                      <div class="relative w-full mt-10">
                        {#each senateTradingList as item}
                        <div class="w-full bg-[#131722] border border-slate-800 shadow-lg h-auto pb-4 pt-4 mb-7">
