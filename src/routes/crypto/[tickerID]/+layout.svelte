                ...
                <div class="flex-1 flex-shrink-0 flex flex-row items-center justify-between -mt-2">
                    ...
                    <div class="{!isScrolled ? 'hidden' : 'flex flex-col items-center ml-6 transition-transform ease-in'}">
                      ...
                      <label on:click={loadSearchData} class="ml-auto mr-4" for="searchBarModal">
                       ...
                       <!--Start Share Button-->
                      <label class="mr-4" on:click={() => shareContent('https://octopi.com/crypto/'+$cryptoTicker)} >
                                        ...
                                        <div class="-ml-2 sm:ml-4 w-screen sm:w-full {$screenWidth < 640 ? 'overflow-auto scrollbar no-scrollbar' : ''} mb-2" >
                                          <ul class="pr-4 sm:pr-0 w-screen font-medium flex flex-row items-center bg-[#0d1117] overflow-x-scroll space-x-3 rtl:space-x-reverse py-2">
                                            <li class="cursor-pointer flex flex-col items-center">
                                              <a href={`/crypto/${$cryptoTicker}`} id="item1" on:click={() => (changeSection('overview','item1'))} class="px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'overview' ? 'text-white ' : 'bg-[#0d1117]'}" >
                                                Overview
                                              </a>
                                              <div class="{displaySection === 'overview' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} mt-1 h-[3px] rounded-full w-[3.5rem]" />
                                            </li>
                                            <li class="cursor-pointer flex flex-col items-center">
                                              <a href={`/crypto/${$cryptoTicker}/stats`} id="item2" on:click={() => (changeSection('stats','item2'))} class="px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'stats' ? 'text-white ' : 'bg-[#0d1117]'}" >Stats</a>
                                              <div class="{displaySection === 'stats' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} mt-1 h-[3px] rounded-full w-[2rem]" />
                                            </li>
                                            <li class="cursor-pointer flex flex-col items-center">
                                              <a href={`/crypto/${$cryptoTicker}/congress-trading`} id="item7" on:click={() => (changeSection('congress-trading','item7'))} class="px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'congress-trading' ? 'text-white ' : 'bg-[#0d1117]'}" >
                                                Insider
                                              </a>
                                              <div class="{displaySection === 'congress-trading' ? 'bg-[#75D377]' : 'bg-[#0d1117]'} mt-1 h-[3px] rounded-full w-[2.5rem]" />
                                            </li>
                                            <li class="cursor-pointer flex flex-col items-center">
                                              <a href={`/crypto/${$cryptoTicker}/news`} id="item7" on:click={() => (changeSection('news','item7'))} class="px-3 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'news' ? 'text-white ' : 'bg-[#0d1117]'}" >
                                                News
                                              </a>
        ...
        <div class="flex flex-col items-center w-full max-w-3xl bg-[#0d1117]">
          ...
          {#each userWatchList as item}
            <label on:click|stopPropagation={() => toggleUserWatchlist(item?.id)} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
                ...
                <div class="flex flex-row items-center w-full bg-[#2A2E39] p-3 rounded-lg {item?.ticker?.includes($cryptoTicker) ? 'ring-2 ring-[#04E000]' : ''}">
