...
<svelte:head>
    <title> {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} Market Heatmaps · octopi</title>
    <meta charset="utf-8" />
    ...
    <!-- Other meta tags -->
    <meta property="og:title" content="Market Heatmaps · octopi"/>
    ...
    <meta name="twitter:title" content="Market Heatmaps · octopi"/>
        ...
        <section in:fly={{ x: -10, duration: 150, delay:150 }} out:fly={{ x: 5, duration: 150 }} class="w-full max-w-4xl overflow-hidden m-auto">
          ...
          <div class="p-0 flex justify-center w-full m-auto overflow-hidden max-w-4xl">
              <div class="relative flex justify-center items-center overflow-hidden w-full">
                  ...
                  <div class="w-full max-w-4xl sm:flex sm:flex-row sm:items-center m-auto text-gray-100 bg-[#131722] sm:rounded-lg h-auto p-5 mb-4 ">
                      <svg class="w-5 h-5 inline-block sm:mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="#a474f6" d="M128 24a104 104 0 1 0 104 104A104.11 104.11 0 0 0 128 24m-4 48a12 12 0 1 1-12 12a12 12 0 0 1 12-12m12 112a16 16 0 0 1-16-16v-40a8 8 0 0 1 0-16a16 16 0 0 1 16 16v40a8 8 0 0 1 0 16"/></svg>
                      <span>
                          Today, <label on:click={() => sectorSelector(lowestSumCategory)} class="cursor-pointer text-[#FFBE00] sm:hover:text-white">{lowestSumCategory}</label> took the lead as the {displayIndex} largest loser, marking a total return of <span class="text-white font-medium">{lowestSum?.toFixed(2)}%</span>, 
                          while <label on:click={() => sectorSelector(highestSumCategory)} class="cursor-pointer text-[#FFBE00] sm:hover:text-white">{highestSumCategory}</label> surged ahead as the top performer with an impressive return of <span class="text-white font-medium">{highestSum?.toFixed(2)}%</span>.
                      </span>
                  </div>
...
<label for="indexModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] sm:bg-[#131722] text-[1.8rem] text-white">
    ✕
</label>
    ...
    <div class="flex flex-col items-center w-full max-w-3xl bg-[#131722] sm:bg-[#131722]">
        ...
        <label for="indexModal" on:click={() => changeIndex('S&P500')} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
            ...
            <div class="flex flex-row items-center w-full bg-[#131722] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'S&P500' ? 'ring-2 ring-[#04E000]' : ''}">
        ...
        <div class="flex flex-row items-center w-full bg-[#131722] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'Dow Jones' ? 'ring-2 ring-[#04E000]' : ''}">
    ...
    <label for="indexModal" on:click={() => changeIndex('Nasdaq')} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
        ...
        <div class="flex flex-row items-center w-full bg-[#131722] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'Nasdaq' ? 'ring-2 ring-[#04E000]' : ''}">
