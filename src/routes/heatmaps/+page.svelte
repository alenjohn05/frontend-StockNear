        ...
        <section in:fly={{ x: -10, duration: 150, delay:150 }} out:fly={{ x: 5, duration: 150 }} class="w-full max-w-4xl overflow-hidden m-auto">
          ...
          <div class="p-0 flex justify-center w-full m-auto overflow-hidden max-w-4xl">
              <div class="relative flex justify-center items-center overflow-hidden w-full">
                  ...
                  <div class="w-full max-w-4xl sm:flex sm:flex-row sm:items-center m-auto text-gray-100 bg-[#0d1117] sm:rounded-lg h-auto p-5 mb-4 ">
...
<label id="indexModal" for="indexModal"  class="cursor-pointer modal-backdrop bg-[#fff] bg-opacity-[0.02] sm:bg-[#0d1117] sm:bg-opacity-[0.5]"></label>
...
<label for="indexModal" class="cursor-pointer absolute right-5 top-2 bg-[#0d1117] sm:bg-[#0d1117] text-[1.8rem] text-white">
    ✕
</label>
    ...
    <div class="flex flex-col items-center w-full max-w-3xl bg-[#0d1117] sm:bg-[#0d1117]">
        ...
        <label for="indexModal" on:click={() => changeIndex('S&P500')} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
            ...
            <div class="flex flex-row items-center w-full bg-[#0d1117] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'S&P500' ? 'ring-2 ring-[#04E000]' : ''}">
        ...
        <div class="flex flex-row items-center w-full bg-[#0d1117] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'Dow Jones' ? 'ring-2 ring-[#04E000]' : ''}">
    ...
    <label for="indexModal" on:click={() => changeIndex('Nasdaq')} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
        ...
        <div class="flex flex-row items-center w-full bg-[#0d1117] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {displayIndex === 'Nasdaq' ? 'ring-2 ring-[#04E000]' : ''}">
