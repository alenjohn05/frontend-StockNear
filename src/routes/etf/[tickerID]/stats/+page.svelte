<script lang="ts">
  ...
  */
  ...
  <svelte:head>
    ...
    <title>
      {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {$displayCompanyName} ({$etfTicker}) Statistics & Valuation Metrics · octopi
    </title>
    ...
    <!-- Other meta tags -->
    <meta property="og:title" content={`${$displayCompanyName} (${$etfTicker}) Statistics & Valuation Metrics · octopi`}/>
    ...
    <meta name="twitter:title" content={`${$displayCompanyName} (${$etfTicker}) Statistics & Valuation Metrics · octopi`}/>
