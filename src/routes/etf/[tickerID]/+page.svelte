            ...
            <div class="pb-12 md:pb-20 w-full max-w-3xl sm:pr-6 xl:pr-0">
              <div class="xl:pr-10">
                                  ...
                                  <!--Start Time Interval-->
                                    ...
                                    <label on:click={changeChartType} class="ml-auto -mt-3 block cursor-pointer bg-[#18181B] sm:hover:bg-[#0d1117] duratiion-100 transition ease-in-out px-3 py-1 rounded-lg shadow-sm">
                                      {#if displayChartType === 'line'}
