...
<svelte:head>
  <title> {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} Largest ETF Providers by Assets Under Management · octopi</title>
  <meta charset="utf-8" />
...
<div class="w-full max-w-4xl m-auto mb-10 bg-[#0d1117] overflow-hidden">
