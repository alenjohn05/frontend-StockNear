...
<svelte:head>
  ...
  <title>
    {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} Largest ETF Providers by Assets Under Management · octopi
  </title>
  ...
  <!-- Other meta tags -->
  <meta property="og:title" content={`Largest ETF Providers by Assets Under Management · octopi`}/>
  ...
  <meta name="twitter:title" content={`Largest ETF Providers by Assets Under Management · octopi`}/>
        ...
        <!-- Page wrapper -->
          <div class="flex justify-center w-full max-w-5xl m-auto h-full overflow-hidden">
              ...
              <div class="relative flex flex-col flex-1 overflow-hidden">
                ...
                <table class="table rounded-none sm:rounded-md w-full border-bg-[#0d1117] m-auto mt-4 ">
                    <thead>
                    ...
                    <tbody>
                      ...
                      <!-- row -->
                      <tr on:click={() => goto("/etf/etf-providers/"+item?.etfProvider)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] odd:bg-[#0d1117] border-b-[#0d1117] shake-ticker cursor-pointer">
                        

                        <td class="text-[#FFBE00] font-medium border-b-[#0d1117]">
                            {formatETFName(item?.etfProvider)}
                        </td>
    
                        <td class="text-white font-medium  border-b-[#0d1117] text-end sm:text-center">
                            {abbreviateNumber(item?.totalAssets, true)}
                        </td>
      
                        <td class="text-white font-medium text-end border-b-[#0d1117]">
                            {item?.funds}
                        </td>
                
      
                        <td class="text-white font-medium text-end hidden sm:table-cell border-b-[#0d1117]">
