...
<svelte:head>
  ...
  <title>
    {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {etfProviderData?.length} {etfProviderName} ETFs - A Complete List · octopi
  </title>
...
<section class="w-full max-w-4xl overflow-hidden m-auto">
            ...
            <div class="stats stats-horizontal bg-[#0d1117] shadow w-full rounded-none sm:rounded-lg overflow-hidden">
