  ...
  >
    ...
    <div class="relative flex flex-col flex-1 overflow-hidden">
      ...
      >
        ...
        <table
          class="hidden sm:inline-table table-sm table-compact rounded-none sm:rounded-md w-full border-bg-[#09090b] m-auto mt-4"
        >
          <table
            class="hidden sm:inline-table table-sm table-compact rounded-none sm:rounded-md w-full border-bg-[#09090b] m-auto mt-4"
          >
            ...
            <tbody>
              {#if rightsIssues.length === 0}
                <tr>
                  <td
                    colspan="4"
                    class="text-center text-white bg-[#09090b] border-b-[#09090b] py-4"
                  >
                    No data available
                  </td>
                </tr>
                ...
                {#each rightsIssues as item, index}
                  ...
                  >
                    ...
                    <td
                      class="{index % 2
                        ? 'bg-[#09090b]'
                        : 'bg-[#141417]'} text-white border-b-[#09090b]"
                    >
                      {item?.Purpose}
                    </td>
                    <td
