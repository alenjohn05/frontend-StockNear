<script lang='ts'>
                    ...
                    {#if displayStructure === 'Card'}
                      <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-5">
                            {#each displayList as item}
                              <label on:click={() => goto(`/politicians/${item?.id}`)} class="w-full cursor-pointer bg-[#09090b] sm:hover:bg-[#09090b] transition-colors ease-in-out border sm:hover:border-[#000] {item?.party ==='Republican' ? 'sm:hover:shadow-[#80000D]' : 'sm:hover:shadow-[#1358C3]' } border-slate-800 shadow-md rounded-lg h-auto pb-4 pt-4 mb-7">
                      ...
                      <div class="w-full m-auto rounded-none sm:rounded-lg mb-4 overflow-x-scroll sm:overflow-hidden">
                        <table class="table table-sm sm:table-md table-pin-cols table-compact rounded-none sm:rounded-md w-full bg-[#09090b] border-bg-[#09090b] m-auto">
                          ...
                          <tbody>
                            ...
                            <tr on:click={() => goto(`/politicians/${item?.id}`)} class="cursor-pointer text-gray-200 odd:bg-[#09090b] border-b-[#09090b] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''}">
  ...
  <dialog id="rowList" class="modal modal-bottom sm:modal-middle ">
    ...
    <label id="rowList" for="rowList"  class="cursor-pointer modal-backdrop bg-[#fff] bg-opacity-[0.05] sm:bg-[#09090b] sm:bg-opacity-[0.5]"></label>
    
    
    <div class="modal-box w-full bg-[#09090b] border border-[#2a2e39] sm:bg-[#09090b] sm:border sm:border-slate-800">
  
      <h3 class="text-white text-2xl font-bold">
        Rows
      </h3>
  
    <label for="rowList" class="sm:hidden cursor-pointer absolute right-5 top-2 bg-[#09090b] sm:bg-[#09090b] text-[1.8rem] text-white">
      ✕
    </label>
  
      <div class="text-white mt-10">
  
        <div class="flex flex-col items-center w-full max-w-3xl bg-[#09090b] sm:bg-[#09090b]">
  ...
  <input type="checkbox" id="exportDataModal" class="modal-toggle" />    
    <dialog id="exportDataModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label id="exportDataModal" for="exportDataModal"  class="cursor-pointer modal-backdrop bg-[#fff] bg-opacity-[0.02] sm:bg-[#09090b] sm:bg-opacity-[0.5]"></label>
      ...
      <label for="exportDataModal" class="cursor-pointer absolute right-5 top-2 bg-[#09090b] sm:bg-[#09090b] text-[1.8rem] text-white">
        ✕
      </label>
  ...
  <dialog id="filterList" class="modal modal-bottom sm:modal-middle">
    ...
    <label id="filterList" for="filterList" class="cursor-pointer modal-backdrop bg-[#09090b] bg-opacity-[0.5]"></label>
    
    
    <div class="modal-box w-full bg-[#09090b] border border-[#2a2e39] sm:border sm:border-slate-800 max-h-[600px] overflow-y-scroll">
  ...
  <div class="drawer drawer-end z-40 overflow-hidden w-screen">
    ...
    <div class="drawer-side overflow-y-scroll overflow-hidden">
      ...
      <div class="bg-[#09090b] min-h-screen w-screen pb-20 overflow-y-scroll overflow-hidden">
  ...
  <div class="space-y-3 sm:pt-5">  
    ...
    <div class="bg-[#09090b] h-auto w-screen">
    
      <!--Start Header-->
      <div class="bg-[#09090b] w-full p-1 flex flex-col items-center pb-10 h-auto">
