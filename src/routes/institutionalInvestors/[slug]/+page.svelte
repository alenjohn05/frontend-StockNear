      ...
      series: [
        {
          ...
          label: {
            ...
            fontSize: 10,
            color: "#fff",
            backgroundColor: "#09090b", // Changed to #09090b
        ...
        <div class="flex justify-center w-full m-auto overflow-hidden">
          ...
          >
            <aside class="relative fixed w-full sm:w-1/3">
              ...
              <div class="w-full mt-5 m-auto flex justify-center items-center">
                <div class="w-full grid grid-cols-2 gap-y-3 lg:gap-y-3 gap-x-3">
                  ...
                  <div
                    class="flex flex-row items-center flex-wrap w-full px-3 sm:px-5 bg-[#09090b] rounded-2xl h-20"
                  >
                    <div class="flex flex-col items-start">
                  ...
                  <!--Start Buy/Sell-->
                  <div
                    class="flex flex-row items-center justify-end flex-wrap w-full px-3 sm:px-5 bg-[#09090b] rounded-2xl h-20"
                  >
            ...
            <main class="w-full mt-10 sm:mt-0 sm:w-3/4 sm:ml-5">
              ...
              <div
                class="p-0 sm:px-2 bg-[#09090b] sm:bg-[#09090b] rounded-lg sm:min-h-auto mb-10 sm:mb-6"
              >
                <Lazy
                  height={800}
              ...
              <div class="w-full flex flex-col justify-center items-center">
                <div
                  class="w-70 sm:w-2/3 h-auto bg-[#141417] tracking-wide mb-14 mx-1 rounded-lg relative"
                >
                  <h5
              ...
              <div
                class="p-0 sm:p-2 bg-[#09090b] sm:bg-[#09090b] rounded-lg sm:min-h-auto mb-10 sm:mb-6"
              >
              ...
              <div
                class="p-0 sm:px-2 mt-10 bg-[#09090b] sm:bg-[#09090b] rounded-lg sm:min-h-auto mb-10 sm:mb-6"
              >
                <Lazy
                  height={800}
                  fadeOption={{ delay: 100, duration: 500 }}
