        ...
        <div class="flex flex-row items-center w-full xl:px-2">
          <div class="flex flex-row items-center cursor-pointer">
            <label
              ...
              class="{!data?.user
                ? 'hidden'
                : ''} cursor-pointer sm:ml-3 mr-1.5 2xl:hidden"
            >
              {#if !showSidebar}
                <svg
  ...
  >
    <aside
      ...
      class="fixed 2xl:block top-0 left-0 xl:left-auto w-56 sm:{collapse
        ? 'w-20'
        : 'w-56'} z-30 min-h-screen pt-12 sm:pt-16 border transition-transform -translate-x-full bg-[#131722] translate-x-0 border-r border-slate-800 border-r border-[#2a2e39]"
    >
