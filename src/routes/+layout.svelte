...
<div class="app {$page?.url?.pathname === '/' ? 'bg-[#000]' : ''}">
  {#if !data?.user}
    <header
      class="sticky {$screenWidth < 640 && hideHeader
        ? 'invisible -mt-20'
        : ''} inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md border border-[#202020] py-3 sm:py-4 shadow-lg sm:backdrop-blur-sm bg-[#202020] sm:bg-opacity-80 md:top-3 md:rounded-2xl lg:max-w-screen-lg"
    >
      <div class="px-4">
        <div class="flex items-center justify-between">
          <div class="flex shrink-0">
            ...
            >
              ...
              />
              <div
                class="flex justify-center items-center text-lg sm:text-xl font-medium mr-auto ml-2"
              >
                <span
                  class="self-center text-gray-200 font-semibold whitespace-nowrap"
                  >Octopi</span
                >
              </div>
            </a>
  ...
  {:else}
    <div class="flex min-h-screen w-full flex-col bg-[#09090B]">
      <aside
        class="fixed overflow-y-scroll scroller overflow-hidden inset-y-0 left-0 z-50 hidden w-72 flex-col 2xl:border-r 2xl:border-gray-800 bg-[#141417] 2xl:flex"
      >
        <nav class="flex flex-col items-center mr-auto gap-y-4 2xl:py-5 w-full">
          ...
          >
            <img class="avatar w-9 2xl:w-12 rounded-full" src={logo} />
            <span class="text-white text-xl">Octopi</span>
          </a>
              ...
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    <a href="/analysts" class="text-[1rem] text-white ml-4 mt-4"
                      >Top Analyst</a
                    >
                    <a
                    ...
                    <a
                      ...
                      class="text-[1rem] text-white ml-4 mt-4">Shorted Stocks</a
                    >
                    <a
                      href="/most-retail-volume"
                      class="text-[1rem] text-white ml-4 mt-4"
                      >Retail Trader Tracker</a
                    >
                    <a
                      href="/stock-screener"
                      class="text-[1rem] text-white ml-4 mt-4">Stock Screener</a
                    >
                    <a
                      href="/market-mover"
                      class="text-[1rem] text-white ml-4 mt-4">Market Mover</a
                    >
                    <a href="/heatmaps" class="text-[1rem] text-white ml-4 mt-4"
                      >Heatmaps</a
                    >
                    <a href="/list" class="text-[1rem] text-white ml-4 mt-4"
                      >Stock Lists</a
                    >
                  </div>
                </Accordion.Content>
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    <a
                      ...
                      class="text-[1rem] text-white ml-4 mt-4">New Launches</a
                    >
                    <a
                      href="/etf/etf-providers"
                      class="text-[1rem] text-white ml-4 mt-4">ETF Providers</a
                    >
                  </div>
                </Accordion.Content>
              </Accordion.Item>
              ...
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    ...
                    <a
                      href="/ipos/2024"
                      class="text-[1rem] text-white ml-4 mt-4">IPO Calendar</a
                    >
              ...
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    <a
                      href="/options-flow"
                      class="text-[1rem] text-white ml-4 mt-4">Options Flow</a
                    >
                    <a
                      href="/options-zero-dte"
                      class="text-[1rem] text-white ml-4 mt-4">0DTE Flow</a
                    >
                  </div>
                </Accordion.Content>
              </Accordion.Item>
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    <a
                      ...
                      class="text-[1rem] text-white ml-4 mt-4">Indices</a
                    >
                  </div>
                </Accordion.Content>
              </Accordion.Item>
              ...
              <Accordion.Item value="item-1">
                ...
                <Accordion.Content class="border-l border-gray-500 ml-2 mt-5">
                  <div class="flex flex-col items-start">
                    <a
                      href="/dividends"
                      class="text-[1rem] text-white ml-4 mt-4">Dividends</a
                    >
                    <a
                      href="/board-meetings"
                      class="text-[1rem] text-white ml-4 mt-4">Board-meetings</a
                    >
                    <a
                      href="/bonus-rights"
                      class="text-[1rem] text-white ml-4 mt-4">Bonus Rights</a
                    >
                    <a
                      href="/ipo-calender"
                      class="text-[1rem] text-white ml-4 mt-4">IPO Calender</a
                    >
                    <a
                      href="/upcoming-events"
                      class="text-[1rem] text-white ml-4 mt-4">Event Results</a
                    >
                  </div>
                </Accordion.Content>
              </Accordion.Item>
              ...
              <Card.Header class="p-2 pt-0 md:p-4">
                ...
                <Card.Description>
                  {#if data?.user?.freeTrial === true}
                    Your free trial will be expired soon. Upgrade now for
                    unlimited access to all features!
                  {:else}
                    Unlock all features of the platform and level up your
                    trading.
                  {/if}
                </Card.Description>
              </Card.Header>
      ...
      <div class="flex flex-col">
        <header
          class="navbar {$screenWidth < 640 && hideHeader
            ? 'invisible -mt-20'
            : ''} sticky top-0 z-40 bg-[#09090B] border-b border-gray-800 flex h-14 items-center gap-4 px-4 sm:h-auto sm:px-6"
        >
          <Sheet.Root>
            <Sheet.Trigger asChild let:builder>
              <Button
                builders={[builder]}
                size="icon"
                class="sm:xl bg-[#09090B] text-white sm:hover:bg-[#27272A] border-none"
              >
                        ...
                        <Sheet.Close asChild let:builder>
                          <div class="flex flex-col items-start">
                            <Button
                              builders={[builder]}
                              type="submit"
                              class="bg-[#141417] hover:bg-[#141417]"
                            >
                              <a
                                href="/analysts"
                                class="text-[1rem] text-white ml-4 mt-2"
                                >Top Analyst</a
                              >
                            </Button>
                            <Button
        ...
        -->
                ...
                <div class="pt-10 w-full mb-5 m-auto sticky">
                  <Card.Root>
                    <Card.Header class="p-4">
                      ...
                      <Card.Description>
                        {#if data?.user?.freeTrial === true}
                          Your free trial will expire soon. Upgrade now for
                          unlimited access to all features!
                        {:else}
                          Unlock all features of the platform and level up your
                          trading.
          ...
          <a href="/" class="-ml-2 flex w-9 flex-shrink-0">
            <img class="avatar w-9 2xl:w-10 rounded-full" src={logo} />
            <span class="text-white font-semibold ml-2 text-lg">Octopi</span>
          </a>
