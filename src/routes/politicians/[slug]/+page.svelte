<script lang="ts">
  ...
  export let data;
  let isLoaded = false;
  let rawData: any = data?.getInstitutionalInvestor;
  let displayList = [];
  let optionsData = {};
...
<section
  class="w-full max-w-6xl overflow-hidden m-auto min-h-screen pt-5 pb-60 sm:px-10 xl:px-0"
>
                ...
                >
                  {#if rawData?.RecentKeyChangeG >= 0}
                    ...
                    <span class="text-[#10DB06] text-md"
                      >+{rawData?.RecentKeyChangeG?.toFixed(2)}%</span
                    >
                  {:else}
                    <svg
                          ...
                          >
                            <div class="flex flex-row items-center">
                              ...
                              <div class="flex flex-col ml-2">
                                ...
                                >
                                <span class="text-white text-opacity-80 text-xs"
                                  >{item?.name?.length > 20
