            ...
            <div class="relative flex flex-col sm:flex-row justify-between items-start overflow-hidden w-full">
              ...
              <aside class="relative fixed w-full sm:w-1/3">        
                ...
                <main class="w-full mt-10 sm:mt-0 sm:w-3/4 sm:ml-5">
                  ...
                  {/if}
                <div class="p-0 sm:p-10 bg-[#111111] sm:bg-[#111111] rounded-lg sm:min-h-[330px]">
                  <div class="w-full m-auto h-auto sm:max-h-[500px] sm:overflow-y-scroll scroller">
                    ...
                    <span class="text-[#F5F5F5] font-bold text-2xl">
                      ...
                      <table class="-ml-2 table table-sm table-compact table-pin-rows table-pin-cols rounded-none sm:rounded-md w-full bg-[#111111] m-auto mt-5 ">
                        <!-- head -->
                        <thead>
                          <tr class="bg-[#111111]">
                        ...
                        <tbody class="p-0">
                          {#each displayList as item}
                              <tr on:click={() => goto(`/${item?.assetType === 'stock' ? 'stocks' : item?.assetType === 'etf' ? 'etf' : 'crypto'}/${item?.ticker}`)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#111111] border-b-[#202020] cursor-pointer">
                                
                                <td class="text-gray-200 pb-3 border-b border-b-[#202020]">
                                  <div class="flex flex-row items-center">
                                    <div class="flex-shrink-0 rounded-full w-8 h-8 relative bg-[#111111] flex items-center justify-center">
                      ...
                      <div class="mt-4 w-full overflow-x-auto scroller">
                        ...
                        <table class="-ml-2 table mt-3 w-screen">
                            ...
                            <tbody>
                              ...
                              <!-- row -->
                              <tr on:click={() => goto(`/${item?.assetType === 'stock' ? 'stocks' : item?.assetType === 'etf' ? 'etf' : 'crypto'}/${item?.ticker}`)} class="w-screen [#111111] border-b-[#111111]">
                                
                                <td class="text-gray-200 pb-3 border-b border-b-[#111111] w-32">
                                  <div class="flex flex-row items-center">
                                ...
                                <td class="text-start text-sm text-white border-b border-b-[#111111] ">
                                  <div class="flex flex-col items-start">
                                    <span class="font-semibold">
                                      {#if item?.type === 'Bought'}
                                        <span class="text-[#57D7BA]">Purchase</span>
