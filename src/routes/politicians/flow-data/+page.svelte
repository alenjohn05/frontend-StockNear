<script lang='ts'>
  ...
  <svelte:head>
      <title> {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} Latest Congressional Trading · octopi</title>
      <meta charset="utf-8" />
      ...
      <!-- Other meta tags -->
      <meta property="og:title" content="Latest Congressional Trading · octopi"/>
      ...
      <meta name="twitter:title" content="Latest Congressional Trading · octopi"/>
                    ...
                    {#if displayStructure === 'Card'}
                      <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-5">
                            {#each displayList as item}
                              <label on:click={() => goto(`/politicians/${item?.id}`)} class="w-full cursor-pointer bg-[#131722] sm:hover:bg-[#131722] transition-colors ease-in-out border sm:hover:border-[#000] {item?.party ==='Republican' ? 'sm:hover:shadow-[#80000D]' : 'sm:hover:shadow-[#1358C3]' } border-slate-800 shadow-md rounded-lg h-auto pb-4 pt-4 mb-7">
                      ...
                      <div class="w-full m-auto rounded-none sm:rounded-lg mb-4 overflow-x-scroll sm:overflow-hidden">
                        <table class="table table-sm sm:table-md table-pin-cols table-compact rounded-none sm:rounded-md w-full bg-[#131722] border-bg-[#131722] m-auto">
                          <thead>
                            <tr class="bg-[#131722] border-b border-blue-400">
                              <th class="bg-[#131722] text-start bg-[#131722] text-white text-sm font-medium sm:font-semibold">
                                Person
                              </th>
                              <td class="text-start bg-[#131722] text-white text-sm font-medium sm:font-semibold">
                                Company
                              </td>
                              <td class="text-end bg-[#131722] text-white text-sm font-medium sm:font-semibold">
                                Transaction
                              </td>
                              <td class="text-end bg-[#131722] text-white text-sm font-medium sm:font-semibold">
                                Disclosure
                              </td>
                              <td class="text-center bg-[#131722] text-white text-sm font-medium sm:font-semibold">
                                Amount
                              </td>
                          ...
                          <tbody>
                            ...
                            <tr on:click={() => goto(`/politicians/${item?.id}`)} class="cursor-pointer text-gray-200 odd:bg-[#131722] border-b-[#131722] {index+1 === rawData?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''}">
                            
                              <th class="{index % 2 ? 'bg-[#131722]' : 'bg-[#131722]'} text-gray-200 ">
                              ...
                              <td on:click|stopPropagation={() => assetSelector(item?.ticker, item?.assetType)} class="cursor-pointer text-start text-xs sm:text-sm text-[#FFBE00]">
                                <div class="flex flex-col items-start">
                                  <span class="text-[#FFBE00]">{item?.ticker?.length !== 0 ? item?.ticker : '-'}</span>
  ...
  <dialog id="rowList" class="modal modal-bottom sm:modal-middle ">
    ...
    <label for="rowList" class="sm:hidden cursor-pointer absolute right-5 top-2 bg-[#131722] sm:bg-[#131722] text-[1.8rem] text-white">
      ✕
    </label>
  
      <div class="text-white mt-10">
  
        <div class="flex flex-col items-center w-full max-w-3xl bg-[#131722] sm:bg-[#131722]">
          ...
          {#each rowList as rows}
            <label on:click={() => changeRows(rows)} for="rowList" class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
                ...
                <div class="flex flex-row items-center w-full bg-[#131722] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg {rows === displayRows ? 'ring-2 ring-[#04E000]' : ''}">
  ...
  <input type="checkbox" id="exportDataModal" class="modal-toggle" />    
    <dialog id="exportDataModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label for="exportDataModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] sm:bg-[#131722] text-[1.8rem] text-white">
        ✕
      </label>
        ...
        <div class="text-white">
          ...
          <div class="flex flex-col items-center w-full max-w-3xl bg-[#131722] sm:bg-[#131722]">
            ...
            <label for="exportDataModal" on:click={() => exportData('excel')} class="cursor-pointer w-full flex flex-row justify-start items-center mb-5">
                ...
                <div class="flex flex-row items-center w-full bg-[#131722] bg-opacity-[0.7] sm:bg-opacity-[1.0] sm:bg-[#303030] p-3 rounded-lg ring-2 ring-[#04E000]">
