                    ...
                    <div class="w-full max-w-4xl ">
                        <div class="sm:flex sm:justify-start">
                            ...
                            <div class="md:grow pt-6 pb-12 w-full sm:mr-4 rounded-2xl sm:rounded-none">
                                <div class="sm:pr-5">
                                   <!--Start Title-->
                                   <h1 class="text-white font-bold text-3xl bg-[#111011] sm:bg-[#0d1117] p-6 sm:p-3 rounded-t-xl -mt-36 sm:mt-0 bg-opacity-[0.9]">
                                    {@html article?.title}
                                    </h1>
                                   <!--End Title-->
                                    <!--Start Writer-->
                                   ...
                                   {#if !data?.user}
                                    ...
                                    <a class="w-64 flex mb-5 justify-center items-center m-auto btn text-white bg-[#161b22] hover:bg-purple-500 transition duration-150 ease-in-out group" href="/register">
                                        Get Started 
