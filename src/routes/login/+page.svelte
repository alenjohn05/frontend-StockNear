				...
				<div class="relative w-full max-w-lg m-auto">
					...
					<form action="?/login" method="POST" use:enhance={submitLogin} class="flex flex-col items-center space-y-2 pt-4 pl-3 pr-3 sm:pl-0 sm:pr-0 ml-auto mr-auto">
						...
						<div class="w-full max-w-lg pt-5 m-auto pb-5">
							<button type="submit" class="btn bg-[#161b22] border border-gray-600 sm:hover:bg-[#161b22] transition duration-100 text-white btn-md w-full rounded-lg m-auto text-white font-semibold text-[1rem]">
                                Login
                            </button>
						</div>
						...
						<p class="pb-1 text-sm w-full max-w-lg text-white flex justify-center items-center">You don't have an account?
							<a href="/register" class="text-[#FFBE00] font-medium hover:underline ml-1">Sign up</a>
						</p>
