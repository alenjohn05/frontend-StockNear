            ...
            <div class="w-full max-w-4xl ">
                ...
                <div class="md:grow pt-6 pb-12 w-full sm:mr-4 rounded-2xl sm:rounded-none">
                    <div class="sm:pr-5">
                        ...
                        <h2 class="mt-10 text-white font-bold text-3xl bg-[#111011] sm:bg-[#131722] p-3 mb-3  bg-opacity-[0.9]">
                           Effect of Time
                        </h2>
                        ...
                        <h2 class="mt-10 text-white font-bold text-3xl bg-[#111011] sm:bg-[#131722] p-3  bg-opacity-[0.9]">
