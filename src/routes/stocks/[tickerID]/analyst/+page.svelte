    ...
    <div class="flex justify-center m-auto h-full overflow-hidden w-full">
        <div class="relative flex justify-center items-center overflow-hidden w-full">
              <div class="sm:p-7 w-full m-auto mt-2 sm:mt-0">
                ...
                <div class="stats stats-horizontal bg-[#0d1117] w-full rounded-lg pr-6 sm:pr-0">
                    ...
                    <div class="stat">
                      ...
                      <div class="stat-value font-semibold text-lg text-gray-200">
                        ...
                        <div class="w-screen -ml-3 sm:w-full sm:ml-0 flex justify-start items-center m-auto overflow-hidden">
                            ...
                            <table class="table table-sm table-compact rounded-none sm:rounded-md w-full border-bg-[#0d1117] m-auto mt-4">
                                <thead class="">
                                  <tr class="">
                                ...
                                <tbody>
                                  ...
                                  <tr on:click={() => goto(`/analysts/${item?.analystId}`)} class="cursor-pointer {latestInfoDate(item?.date) ? 'bg-[#F9AB00] bg-opacity-[0.1]' : 'odd:bg-[#0d1117]'} border-b-[#0d1117]  {index+1 === historyList?.slice(0,3)?.length && data?.user?.tier !== 'Pro' ? 'opacity-[0.1]' : ''}">
                                  ...
                                  <td class="text-white text-end font-medium text-sm sm:w-auto">
                                    <div class="flex flex-col items-end">
                                      {#if latestInfoDate(item?.date)}
                                        <label class="bg-[#2962ff] text-white font-medium text-xs rounded-lg px-2 py-0.5 ml-3 mb-1">
                                          New
                                        </label>
                                      {/if}
