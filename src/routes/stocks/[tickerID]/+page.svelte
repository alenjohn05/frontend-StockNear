...
function changeChartType() {
  ...
  <svelte:head>
    ...
    <title>
      {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {$displayCompanyName} ({$stockTicker}) Stock Price, Quote & News · octopi
    </title>
    ...
    <!-- Other meta tags -->
    <meta property="og:title" content={`${$displayCompanyName} (${$stockTicker}) Stock Price, Quote & News · octopi`}/>
    ...
    <meta name="twitter:title" content={`${$displayCompanyName} (${$stockTicker}) Stock Price, Quote & News · octopi`}/>
  ...
  <section class="bg-[#111111] min-h-screen pb-40 overflow-hidden">
                          ...
                          <div class="xl:pr-10">
                                ...
                                <!-----End-Header-CandleChart-Indicators------>
                                   ...
                                   <div class="hidden sm:flex flex-row items-center pl-1 sm:pl-6 w-full mt-4">
                                    ...
                                    <button on:click={() => changeData('1D')} class="text-sm font-medium text-gray-400 {displayData === '1D' ? 'text-white ' : 'bg-[#111111]'}">
                                        1D
                                    </button>
                                    <div class="{displayData === '1D' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem] rounded-full" />
                                    </div>
                                    <div class="flex flex-col items-center mr-4">
                                    <button on:click={() => (changeData('1W'))} class="w-full text-sm font-medium text-gray-400 {displayData === '1W' ? 'text-white ' : 'bg-[#111111]'}">
                                        1W
                                    </button>
                                    <div class="{displayData === '1W' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem]" />
                                    </div>
                                    <div class="flex flex-col items-center mr-4">
                                    <button on:click={() => (changeData('1M'))} class="text-sm font-medium text-gray-400 {displayData === '1M' ? 'text-white ' : 'bg-[#111111]'}">
                                        1M
                                    </button>
                                    <div class="{displayData === '1M' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem]" />
                                    </div>
                                    <div class="flex flex-col items-center mr-4">
                                    <button on:click={() => changeData('6M')} class="text-sm font-medium text-gray-400 {displayData === '6M' ? 'text-white ' : 'bg-[#111111]'}">
                                        6M
                                    </button>
                                    <div class="{displayData === '6M' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem]" />
                                    </div>
                                  <div class="flex flex-col items-center mr-4">
                                    <button on:click={() => changeData('1Y')} class="text-sm font-medium text-gray-400 {displayData === '1Y' ? 'text-white ' : 'bg-[#111111]'}">
                                        1Y
                                    </button>
                                    <div class="{displayData === '1Y' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem]" />
                                  </div>
                                  
                                  <div class="flex flex-col items-center mr-4">
                                    <button on:click={() => changeData('MAX')} class="text-sm font-medium text-gray-400 {displayData === 'MAX' ? 'text-white ' : 'bg-[#111111]'}">
                                        MAX
                                    </button>
                                    <div class="{displayData === 'MAX' ? `bg-[${colorChange}]` : 'bg-[#111111]'} mt-1 h-[3px] w-[1.5rem]" />
                                  
                                  </div>


  
                                  <label on:click={changeChartType} class="ml-auto -mt-3 block cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duratiion-100 transition ease-in-out px-3 py-1 rounded-lg shadow-sm">
                                    {#if displayChartType === 'line'}
