                          ...
                          {:else}
                            ...
                            <div class="flex justify-start items-center w-full m-auto shadow-md rounded-none sm:rounded-lg mb-4">
                              <table class="table table-sm table-compact flex justify-start items-center w-full m-auto">
                                <thead>
                                  <tr class="bg-[#131722] border-b-slate-600 shadow-md">
                                    <th class="text-start bg-[#131722] border-b border-[#141720] text-white text-sm font-semibold">
                                      Ex-Divid. Date
                                    </th>
                                    <th class="text-end bg-[#131722] border-b border-[#141720] text-white text-sm font-semibold">
                                      Cash Amount
                                    </th>
                                    <th class="text-end bg-[#131722] border-b border-[#141720] hidden sm:table-cell text-white text-sm font-semibold">
                                      Record Date
                                    </th>
                                    <th class="text-end bg-[#131722] border-b border-[#141720] text-white text-sm font-semibold">
                                      Pay Date
                                ...
                                <tbody class="shadow-md">
                                  ...
                                  <tr class="text-gray-200 odd:bg-[#131722]">
                                    ...
                                    <td class="text-end text-xs sm:text-sm hidden sm:table-cell text-white border-b border-[#141720]">
