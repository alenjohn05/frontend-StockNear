...
<script lang='ts'>
  ...
  notDestroyed = false;
                      ...
                      <div class="sm:p-7 sm:w-full sm:max-w-3xl m-auto mt-5 sm:mt-0">
                        <div class="mb-6 w-full">
                            ...
                            <div class="flex flex-row items-center mb-5 pt-3 justify-center sm:justify-end">
                              <label for="quarterModal" class="ml-1 sm:ml-3 text-sm cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Quarter: Q{quarter}
                              </label>
                              <label for="yearModal" class="ml-3 text-sm cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Year: {year}
                              </label>
                              <label on:click={() => getTranscripts()} class="ml-3 text-sm cursor-pointer bg-[#111111] sm:hover:bg-[#111111] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Run
                              </label>
                            </div>
    ...
    <dialog id="quarterModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label id="quarterModal" for="quarterModal"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
      ...
      <label for="quarterModal" class="cursor-pointer absolute right-5 top-2 bg-[#111111] text-[1.8rem] text-white">
        ✕
      </label>
    ...
    <dialog id="yearModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label id="yearModal" for="yearModal"  class="cursor-pointer modal-backdrop bg-[#111111] bg-opacity-[0.5]"></label>
      ...
      <label for="yearModal" class="cursor-pointer absolute right-5 top-2 bg-[#111111] text-[1.8rem] text-white">
        ✕
      </label>
