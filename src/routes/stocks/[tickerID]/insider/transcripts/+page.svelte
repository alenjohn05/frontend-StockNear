<script lang='ts'>
  ...
  notDestroyed = false;
                      ...
                      <div class="sm:p-7 sm:w-full sm:max-w-3xl m-auto mt-5 sm:mt-0">
                        <div class="mb-6 w-full">
                            ...
                            <div class="flex flex-row items-center mb-5 pt-3 justify-center sm:justify-end">
                              <label for="quarterModal" class="ml-1 sm:ml-3 text-sm cursor-pointer bg-[#131722] sm:hover:bg-[#131722] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Quarter: Q{quarter}
                              </label>
                              <label for="yearModal" class="ml-3 text-sm cursor-pointer bg-[#131722] sm:hover:bg-[#131722] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Year: {year}
                              </label>
                              <label on:click={() => getTranscripts()} class="ml-3 text-sm cursor-pointer bg-[#131722] sm:hover:bg-[#131722] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                  Run
                              </label>
                            </div>
    ...
    <dialog id="quarterModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label for="quarterModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-[1.8rem] text-white">
        ✕
      </label>
    ...
    <dialog id="yearModal" class="modal modal-bottom sm:modal-middle ">
      ...
      <label for="yearModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-[1.8rem] text-white">
        ✕
      </label>
