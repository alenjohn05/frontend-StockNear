...
<title>
    {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {$displayCompanyName} ({$stockTicker}) Balance Sheet &#183 octopi
</title>
...
<!-- Other meta tags -->
<meta property="og:title" content={`${$displayCompanyName} (${$stockTicker}) Balance Sheet &#183 octopi`}/>
...
<meta name="twitter:title" content={`${$displayCompanyName} (${$stockTicker}) Balance Sheet &#183 octopi`}/>
...
<!-- Add more Twitter meta tags as needed -->
    ...
    <section class="bg-[#131722] overflow-hidden text-white h-full pb-40 sm:mb-0">
                ...
                <main>
                    <div class="sm:p-7 m-auto mt-2 sm:mt-0">
                        ...
                        <div class="grid grid-cols-1 gap-2">
                            ...
                            <label for="timeFrameModal" class="cursor-pointer bg-[#131722] sm:hover:bg-[#2A2E39] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                            ...
                            <!--
                            <label for="exportDataModal" class="ml-3 mr-2 sm:mr-0 cursor-pointer bg-[#131722] sm:hover:bg-[#2A2E39] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                                <div class="flex flex-row items-center">
                                    ...
                                    {:else}
                                        ...
                                        <div class="w-full rounded-none sm:rounded-lg m-auto overflow-x-auto">
                                            <table class="table w-full">
                                                <thead>
                                                    <tr class="text-white ">
                                                        <td class="text-start border-r border-[#191E24] bg-[#131722] text-white text-sm sm:text-[1rem] font-bold pr-10">Year</td>
                                                        {#each balanceSheet as balance}
                                                        {#if filterRule === 'annual'}
                                                            <td class="bg-[#131722] font-semibold pr-5 sm:pr-14 text-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <!-- row -->
                                                    <tr class="text-white odd:bg-[#131722]">
  ...
  <dialog id="timeFrameModal" class="modal modal-bottom sm:modal-middle ">
    ...
    <label for="timeFrameModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-[1.8rem] text-white">
      ✕
    </label>
  ...
  <dialog id="exportDataModal" class="modal modal-bottom sm:modal-middle ">
    ...
    <label for="exportDataModal" class="cursor-pointer absolute right-5 top-2 bg-[#131722] text-[1.8rem] text-white">
      ✕
    </label>
