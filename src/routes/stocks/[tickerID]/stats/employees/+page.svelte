                    ...
                    <!--End Column-->
                      ...
                      <div class="flex flex-row items-center w-full mt-10 mb-8">
                          ...
                          <div class="{employeeHistory?.length === 0 ? 'hidden' : ''} flex justify-end ml-auto items-center mr-2">
                                  ...
                                  <label for="sortByModal" class="cursor-pointer bg-[#0d1117] sm:hover:bg-[#2A2E39] duration-100 transition ease-in-out px-4 py-1.5 rounded-lg shadow-md">
                          ...
                          <div class="flex justify-start items-center w-full m-auto pr-1 pl-1 p-3">
                              ...
                              <thead>
                                  <tr>
                                  <th class="text-start border-b border-[#141720] bg-[#0d1117] text-white text-sm font-semibiold">
                                      Date
                                  </th>
                                  <th class="text-end border-b border-[#141720] bg-[#0d1117] text-white text-sm font-semibiold">
                                      Employees
                                  </th>
                                  <th class="text-end border-b border-[#141720] bg-[#0d1117] hidden sm:table-cell text-white text-sm font-semibiold">
                                      Change
                                  </th>
                                  <th class="text-end border-b border-[#141720] bg-[#0d1117] text-white text-sm font-semibiold">
                                      Growth
                              ...
                              <tbody class="">
                                ...
                                <tr class="text-gray-200 odd:bg-[#0d1117]">
                                  ...
                                  <td class="text-end border-b border-[#141720] text-xs sm:text-sm text-white">
                                    {new Intl.NumberFormat("en").format(item?.employeeCount)}
                                  </td>
                                  <td class="text-end border-b border-[#141720] text-xs sm:text-sm hidden sm:table-cell text-white">
                                    {abbreviateNumber(item?.employeeCount-historyList[index+1]?.employeeCount)}
                                  </td>
                                  <td class="text-end border-b border-[#141720] text-xs sm:text-sm text-white text-end">
