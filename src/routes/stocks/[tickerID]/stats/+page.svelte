...
<svelte:head>
  ...
  <title>
    {$numberOfUnreadNotification > 0 ? `(${$numberOfUnreadNotification})` : ''} {$displayCompanyName} ({$stockTicker}) Statistics & Valuation Metrics · octopi
  </title>
  ...
  <!-- Other meta tags -->
  <meta property="og:title" content={`${$displayCompanyName} (${$stockTicker}) Statistics & Valuation Metrics · octopi`}/>
  ...
  <meta name="twitter:title" content={`${$displayCompanyName} (${$stockTicker}) Statistics & Valuation Metrics · octopi`}/>
        ...
        <div class="grid grid-cols-1 gap-2 mt-10">
              ...
              <div class="flex justify-start items-center w-full m-auto">
                <table class="table table-sm table-compact text-start flex justify-start items-center w-full px-3 m-auto">
                  <tbody class="shadow-md">
                    <!-- row 1 -->
                    <tr class="text-white odd:bg-[#131722] font-semibold">
              ...
              <table class="table table-sm table-pin-rows table-compact text-start w-full flex justify-start items-center m-auto">
                <thead>
                  <tr class="bg-[#131722] border-slate-800 rounded text-white font-semibold">
                ...
                <tbody class="shadow-md">
                  {#each quantStats[$stockTicker?.toUpperCase()]['Worst 10 Drawdowns'] as item}
                    <tr class="text-white border-y border-gray-800 odd:bg-[#131722]">
              ...
              <div class="flex flex-col justify-center items-center w-full m-auto">
                <table class="table table-sm table-pin-rows table-compact text-start w-full flex justify-start items-center w-full m-auto">
                  <thead>
                    <tr class="bg-[#131722] text-white text-sm font-medium">
                      <th class="text-start">
                        Metric
                      </th>
                      <th class="text-end bg-[#131722]">
                        {$stockTicker}
                      </th>
                      <th class="text-end">
                        S&P500
