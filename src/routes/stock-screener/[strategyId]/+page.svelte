    ...
    <div class="text-sm breadcrumbs ml-4">
      <ul>
        ...
        <li class="text-gray-300">{title ?? 'Demo'}</li>  
            ...
            <div class="bg-[#131722] mt-5 sm:rounded-xl sm:border sm:hover:border-slate-700 sm:border-slate-800 pb-10">
              ...
              <div class="mt-3 sm:mt-0 w-full max-w-3xl flex flex-col justify-center sm:flex-row sm:justify-between items-center sm:ml-10">
                <label id="step-1" for="ruleModal" class="w-5/6 sm:w-full text-white text-sm bg-[#131722] border border-slate-800 p-1.5 rounded-full cursor-pointer">
              ...
              <!--Start AI Trend Analysis Rule-->
               ...
               <div class="w-full max-w-xl text-white font-medium text-[1rem] flex flex-row justify-center items-center">
                 ...
                 <label on:click={() => changeRuleCondition('below')} class="ml-5 cursor-pointer flex flex-row mr-2 justify-center items-center">
                   <input type="radio" class="radio checked:bg-purple-600 bg-[#131722] border border-slate-800 mr-2" checked={ruleCondition[ruleName] === 'below'} />
                 ...
                 <label on:click={() => changeRuleCondition('above')} class="cursor-pointer flex flex-row ml-2 justify-center items-center">
                   <input type="radio" class="radio checked:bg-purple-600 bg-[#131722] border border-slate-800 mr-2" checked={ruleCondition[ruleName] === 'above'} />
              ...
              <div class="w-full max-w-xl text-white font-medium text-lg flex flex-row justify-center items-center">
                ...
                <label on:click={() => changeRuleCondition('below')} class="ml-5 cursor-pointer flex flex-row mr-2 justify-center items-center">
                  <input type="radio" name="radio-revenue-below" class="radio checked:bg-purple-600 bg-[#131722] border border-slate-800 mr-2" checked={ruleCondition[ruleName] === 'below'} />
                  <span class="label-text text-white">Below</span> 
                </label>
                <label on:click={() => changeRuleCondition('above')} class="cursor-pointer flex flex-row ml-2 justify-center items-center">
                  <input type="radio" name="radio-revenue-above" class="radio checked:bg-purple-600 bg-[#131722] border border-slate-800 mr-2" checked={ruleCondition[ruleName] === 'above'} />
                  <span class="label-text text-white">Above</span> 
                </label>
            ...
            <!--End Change 3Y Rule-->
                  ...
                  <!--Start Rules Preview -->
                    ...
                    <div id="step-3" class="w-full max-w-3xl bg-[#131722] sm:ml-10 h-auto max-h-[400px] no-scrollbar overflow-hidden overflow-y-scroll p-5 sm:rounded-xl border-b sm:border sm:hover:border-slate-700 border-slate-800 pb-10">
            ...
            <!--End Build Strategy-->
               ...
               <div class="bg-[#131722] sm:border border-slate-800 sm:hover:border-slate-700 mt-5 sm:rounded-2xl ">
                  ...
                  <div class="w-full rounded-lg overflow-x-auto p-0 sm:p-3">
                    <table class="table table-sm table-compact w-full bg-[#131722] border-bg-[#131722]">
                      ...
                      <tbody>
                        ...
                        <tr on:click={() => goto("/stocks/"+item?.symbol)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] bg-[#131722] border-b-[#131722] odd:bg-[#131722] cursor-pointer">
                          <td class="border-b-[#131722]">
                          ...
                          <td class="hidden sm:table-cell text-white border-b-[#131722]">
                            {item?.name?.length > charNumber ? item?.name?.slice(0,charNumber) + "..." : item?.name}
                          </td>
                          
                          <td class="text-white border-b-[#131722]">
...
<div class="drawer drawer-end z-50">
  ...
  <div class="drawer-side overflow-x-hidden">
    ...
    <div class="menu w-screen min-h-full bg-[#131722] text-base-content overflow-hidden">
      <div style="top: 0rem;" class="flex flex-row fixed sticky h-14 z-40 bg-[#131722] justify-center items-center w-full border-b border-slate-900">
